...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Akademik /</span> Pengaturan KKM</h4>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <form action="{{ route('waka.promotion.kkm.index') }}" method="GET" class="d-flex">
