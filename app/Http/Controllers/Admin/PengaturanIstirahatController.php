...
class PengaturanIstirahatController extends Controller
{
    public function index()
    {
        ...
        return view('admin.pengaturan-istirahat.index', compact('jenjangList', 'pengaturanPerJenjang'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $selectedJenjang = $request->query('jenjang'); // Auto-lock jenjang dari button per-jenjang

        return view('admin.pengaturan-istirahat.create', compact('jenjangList', 'hariList', 'selectedJenjang'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.pengaturan-istirahat.index')
    ...
    public function edit($id)
    {
        ...
        return view('admin.pengaturan-istirahat.edit', compact('pengaturan', 'jenjangList', 'hariList'));
    }
