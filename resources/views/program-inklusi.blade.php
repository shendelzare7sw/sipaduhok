    ...
    <section class="relative h-[400px] flex items-center justify-center" style="background-image: url('{{ asset('img/hero-bg.jpg') }}'); background-size: cover; background-position: center;">
        ...
        <div class="relative z-10 text-center text-white px-4">
            <nav class="text-sm mb-4">
                ...
                <span>Program</span>
                <span class="mx-2">/</span>
                <span class="font-semibold">Program Inklusi</span>
            </nav>
            <h1 class="text-4xl md:text-5xl font-bold">Program Inklusi</h1>
            <p class="mt-4 text-lg text-white/90">Pendidikan untuk Anak Berkebutuhan Khusus</p>
        </div>
    </section>
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="relative">
                    <img src="{{ asset('img/inklusi-main.jpg') }}" alt="Program Inklusi" class="rounded-2xl shadow-xl w-full h-[400px] object-cover">
                ...
                <div>
                    <span class="inline-block bg-[#d45930]/20 text-[#d45930] px-4 py-2 rounded-full text-sm font-semibold mb-4">Program Inklusi</span>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Pendidikan Inklusif</h2>
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Program Inklusi kami dirancang khusus untuk anak-anak berkebutuhan khusus (ABK) agar dapat belajar bersama dengan anak-anak lainnya dalam lingkungan yang inklusif dan mendukung.
                    </p>
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Dengan pendekatan individual dan dukungan dari tenaga ahli, setiap anak mendapatkan kesempatan yang sama untuk berkembang sesuai dengan potensinya masing-masing.
                    </p>
                    <a href="{{ url('/kontak') }}" class="inline-flex items-center px-6 py-3 bg-[#d45930] text-white font-semibold rounded-full hover:bg-[#165fac] transition">
                        Konsultasi Gratis
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="inline-block bg-[#165fac]/10 text-[#165fac] px-4 py-2 rounded-full text-sm font-semibold mb-4">Layanan Kami</span>
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800">Jenis Kebutuhan yang Kami Layani</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="card-hover bg-gray-50 rounded-2xl p-8 border-t-4 border-[#165fac]" onclick="openModal('autism')">
                    <div class="w-14 h-14 bg-[#165fac]/10 rounded-xl flex items-center justify-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-[#165fac]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="card-hover bg-gray-50 rounded-2xl p-8 border-t-4 border-[#287f3b]" onclick="openModal('adhd')">
                    <div class="w-14 h-14 bg-[#287f3b]/10 rounded-xl flex items-center justify-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-[#287f3b]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="card-hover bg-gray-50 rounded-2xl p-8 border-t-4 border-[#d45930]" onclick="openModal('disleksia')">
                    <div class="w-14 h-14 bg-[#d45930]/10 rounded-xl flex items-center justify-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-[#d45930]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="card-hover bg-gray-50 rounded-2xl p-8 border-t-4 border-[#fac030]" onclick="openModal('down')">
                    <div class="w-14 h-14 bg-[#fac030]/10 rounded-xl flex items-center justify-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-[#fac030]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <a href="{{ url('/profil-guru') }}" class="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
                ...
                <a href="{{ url('/profil-guru') }}" class="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
                    <div class="w-16 h-16 bg-[#fac030]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-[#fac030]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13M0 18h.897c.35 0 .684-.188.897-.53l6.5-6.5c.78-.78 2.028-2.865 2.397-3.83M9.5 3L7.5 5h4v6H7.5V7h2.5z"/>
                        </svg>
                    </div>
    ...
    <section class="py-16" style="background: linear-gradient(135deg, #d45930 0%, #fac030 100%);">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ url('/ppdb') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white text-[#d45930] font-semibold rounded-full hover:bg-gray-100 transition">
                    Daftar Sekarang
                </a>
                <a href="{{ url('/kontak') }}" class="inline-flex items-center justify-center px-8 py-4 border-2 border-white text-white font-semibold rounded-full hover:bg-white hover:text-[#d45930] transition">
                    Konsultasi Gratis
                </a>
            </div>
        </div>
