        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('bendahara.kenaikan-kelas.validation.index') }}" class="btn btn-outline-secondary btn-sm">
                        <i class="bi bi-arrow-left me-1"></i>Kembali
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('bendahara.kenaikan-kelas.validation.history') }}" method="GET" class="mb-4">
                        <div class="row g-3">
                            <div class="col-md-3">
                    ...
                    <form id="bulkDeleteForm" method="POST" action="{{ route('bendahara.kenaikan-kelas.validation.history.bulk-delete') }}">
                        @csrf
