        ...
        <div class="d-flex">
            ...
            <div>
                ...
                <p class="mb-0 mt-2">
                    ...
                    Untuk tagihan <strong>SPP Bulanan</strong>, gunakan fitur <a href="{{ route('bendahara.tagihan.generate-spp') }}" class="alert-link fw-bold">"Generate SPP"</a> yang lebih akurat.
                </p>
            </div>
        </div>
    </div>
