    ...
    <div class="card shadow mb-4">
        <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-3">
            ...
            <div class="d-flex flex-wrap align-items-center gap-3 w-100-mobile">
                ...
                @if($isAlumniMode ?? false)
                    <a href="{{ route('bendahara.tagihan.index') }}" class="btn btn-warning btn-sm fw-bold shadow-sm w-100-mobile" title="Kembali ke daftar semua siswa">
                        <i class="fas fa-user-graduate me-1"></i> Alumni Menunggak
                        <span class="badge bg-dark ms-1">aktif</span> <i class="fas fa-times ms-1"></i>
                    </a>
                @else
                    <a href="{{ route('bendahara.tagihan.index', ['tunggakan_alumni' => 1]) }}" class="btn btn-outline-warning btn-sm fw-bold w-100-mobile" title="Tampilkan alumni yang masih punya tunggakan (lintas tahun ajaran)">
                        <i class="fas fa-user-graduate me-1"></i> Alumni Menunggak
                    </a>
                @endif
            </div>
