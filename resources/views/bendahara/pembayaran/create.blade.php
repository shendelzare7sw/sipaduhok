...
<div class="container-fluid px-0">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('bendahara.pembayaran.store', $siswa->id) }}" method="POST" enctype="multipart/form-data" data-payment-form>
                @csrf
...
@section('scripts')
    @vite(['resources/js/bendahara/pembayaran/create.js'])
@endsection
