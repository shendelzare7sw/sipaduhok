        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <!-- Rest of content -->
                <div>
                    ...
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Dengan kurikulum yang disesuaikan dan metode pembelajaran yang fleksibel, siswa dapat belajar sesuai dengan kecepatan masing-masing sambil tetap mencapai kompetensi yang diharapkan.
                    </p>
                    <div class="grid grid-cols-2 gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-gray-700 font-medium">Ijazah Resmi</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-[#287f3b]/10 rounded-full flex items-center justify-center">
                                <svg class="w-5 h-5 text-[#287f3b]" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span class="text-gray-700 font-medium">Jadwal Fleksibel</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-[#287f3b]/10 rounded-full flex items-center justify-center">
                                <svg class="w-5 h-5 text-[#287f3b]" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span class="text-gray-700 font-medium">Kelas Kecil</span>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-[#287f3b]/10 rounded-full flex items-center justify-center">
                                <svg class="w-5 h-5 text-[#287f3b]" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span class="text-gray-700 font-medium">Bimbingan Intensif</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8">
                <ul class="space-y-4">
                    <li class="flex items-start gap-4">
                        <div class="w-8 h-8 bg-[#165fac] text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">1</div>
                        <div>
                    ...
                    <li class="flex items-start gap-4">
                        <div class="w-8 h-8 bg-[#165fac] text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">2</div>
                        <div>
                    ...
                    <li class="flex items-start gap-4">
                        <div class="w-8 h-8 bg-[#165fac] text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">3</div>
                        <div>
                    ...
                    <li class="flex items-start gap-4">
                        <div class="w-8 h-8 bg-[#165fac] text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">4</div>
                        <div>
