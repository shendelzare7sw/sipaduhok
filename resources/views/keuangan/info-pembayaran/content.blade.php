...
<div class="pay-shell">
    <div class="stat-row">
        ...
        <div class="stat-widget">
            ...
            <div><div class="stat-value">{{ $gatewayEnabled ? 'Aktif' : ($gatewayConfigured ? 'Off' : 'Belum') }}</div><div class="stat-label">Pembayaran Digital</div><div class="stat-desc">{{ $gatewayConfigured ? ($isProduction ? 'Mode production' : 'Mode sandbox') : 'API key aktif belum tersedia' }}</div></div>
        </div>
        <div class="stat-widget">
