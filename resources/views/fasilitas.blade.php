...
<body class="bg-white">
    ...
    <section class="relative min-h-screen flex items-center" 
        style="
            background-image: url('{{ asset('img/bg-fasilitas.jpg') }}'); 
        ...
        <!-- Decorative Blobs -->
        <div class="decorative-blob absolute top-20 left-10 w-96 h-96 bg-accent-yellow" style="animation-delay: 0s;"></div>
        <div class="decorative-blob absolute bottom-20 right-20 w-80 h-80 bg-secondary" style="animation-delay: 2s;"></div>
        
        <!-- Decorative Elements -->
        <div class="absolute top-32 left-16 w-20 h-20 border-4 border-white/20 rounded-full float-animation hidden lg:block"></div>
        <div class="absolute bottom-40 left-32 w-12 h-12 bg-accent-yellow/30 rounded-full float-animation hidden lg:block" style="animation-delay: 1s;"></div>
        <div class="absolute top-48 right-40 w-16 h-16 border-4 border-white/30 rounded-lg rotate-45 float-animation hidden lg:block" style="animation-delay: 2s;"></div>
        <div class="absolute bottom-32 right-16 w-10 h-10 bg-white/20 rounded-full float-animation hidden lg:block" style="animation-delay: 1.5s;"></div>
        
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-20">
            <div class="text-center">
                <span class="inline-block px-6 py-2 bg-white/20 backdrop-blur-sm text-white text-sm font-medium rounded-full mb-6 fade-in-up">
                    Fasilitas Lengkap & Modern
                </span>
                <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6 fade-in-up" style="animation-delay: 0.2s;">
                    Fasilitas<br>
                    <span class="text-accent-yellow">Terbaik</span> Untuk<br>
                    Pembelajaran Optimal
                </h1>
                <p class="text-lg md:text-xl text-white/90 mb-12 leading-relaxed max-w-3xl mx-auto fade-in-up" style="animation-delay: 0.4s;">
                    PKBM House Of Knowledge menyediakan fasilitas lengkap dan modern untuk mendukung proses belajar mengajar yang efektif dan menyenangkan
                </p>
                
                <!-- Quick Stats -->
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto scale-in" style="animation-delay: 0.6s;">
                    <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                        <p class="text-4xl font-bold text-white mb-2">20+</p>
                        <p class="text-white/80 text-sm">Ruang Kelas</p>
                    </div>
                    <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                        <p class="text-4xl font-bold text-white mb-2">30+</p>
                        <p class="text-white/80 text-sm">Alat Terapi</p>
                    </div>
                    <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                        <p class="text-4xl font-bold text-white mb-2">3+</p>
                        <p class="text-white/80 text-sm">Area Bermain</p>
                    </div>
                    <div class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
                        <p class="text-4xl font-bold text-white mb-2">1000+</p>
                        <p class="text-white/80 text-sm">Koleksi Buku</p>
                    </div>
                </div>
                
                <div class="mt-12 fade-in-up" style="animation-delay: 0.8s;">
                    <a href="#fasilitas" class="inline-flex items-center justify-center px-8 py-4 bg-white text-primary hover:bg-cream font-semibold rounded-full shadow-2xl transition-all duration-300 hover:-translate-y-1">
                        Jelajahi Fasilitas
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center icon-float">
                                <svg class="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3z"/>
                                </svg>
                            </div>
                            <span class="px-4 py-2 bg-primary/10 text-primary text-sm font-medium rounded-full">Fasilitas Utama</span>
                        </div>
                        
                        <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Ruang Belajar</h2>
                        <p class="text-gray-600 mb-6 leading-relaxed text-lg">
                            Ruang belajar kami dirancang dengan konsep modern dan nyaman untuk menciptakan suasana belajar yang kondusif. Dilengkapi dengan teknologi pembelajaran terkini dan tata ruang yang mendukung interaksi optimal antara guru dan siswa.
                        </p>
                        
                        <div class="space-y-4">
                            <div class="feature-item flex items-start gap-4">
                                <div class="flex-shrink-0 w-8 h-8 bg-primary rounded-full flex items-center justify-center mt-1">
                                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                    </svg>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-gray-800 mb-1">Kapasitas 8-15 Siswa</h4>
                                    <p class="text-gray-600 text-sm">Ukuran kelas ideal untuk pembelajaran personal</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-800 mb-1">Ruangan Ber AC</h4>
                                    <p class="text-gray-600 text-sm">Setiap ruangan dilengkapi dengan AC untuk kenyamanan siswa.</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-800 mb-1">Furniture Ergonomis</h4>
                                    <p class="text-gray-600 text-sm">Meja dan kursi yang nyaman untuk belajar</p>
                                </div>
                            </div>
            ...
            <div class="mb-32">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="order-2 lg:order-1">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-16 h-16 bg-accent-orange/10 rounded-2xl flex items-center justify-center icon-float">
                                <svg class="w-8 h-8 text-accent-orange" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd"/>
                                </svg>
                            </div>
                            <span class="px-4 py-2 bg-accent-orange/10 text-accent-orange text-sm font-medium rounded-full">Program Terapi</span>
                        </div>
                        
                        <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Ruang Terapi</h2>
                        <p class="text-gray-600 mb-6 leading-relaxed text-lg">
                            Menyediakan berbagai alat terapi yang digunakan khusus untuk mendukung perkembangan motorik dan sensorik pada anak-anak berkebutuhan khusus.
                        </p>
                        
                        <div class="space-y-4">
                            <div class="feature-item flex items-start gap-4">
                                <div class="flex-shrink-0 w-8 h-8 bg-accent-orange rounded-full flex items-center justify-center mt-1">
                                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                    </svg>
                                </div>
            ...
            <div class="mb-32">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-16 h-16 bg-accent-yellow/10 rounded-2xl flex items-center justify-center icon-float">
                            ...
                            <span class="px-4 py-2 bg-accent-yellow/10 text-accent-yellow text-sm font-medium rounded-full">Fasilitas Rekreasi</span>
                        </div>
                        
                        <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Area Bermain</h2>
                        <p class="text-gray-600 mb-6 leading-relaxed text-lg">
                            Area bermain yang luas dan aman untuk mengembangkan motorik kasar anak. Dilengkapi dengan berbagai permainan edukatif yang mendukung perkembangan fisik dan sosial anak.
                        </p>
                        
                        <div class="space-y-4">
                            <div class="feature-item flex items-start gap-4">
                                <div class="flex-shrink-0 w-8 h-8 bg-accent-yellow rounded-full flex items-center justify-center mt-1">
                                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                    </svg>
                                </div>
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Fasilitas bermain dengan standar keamanan tinggi</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-item flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Bermain sambil belajar untuk perkembangan optimal</p>
                                </div>
                            </div>
            ...
            <div class="mb-32">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="order-2 lg:order-1">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-16 h-16 bg-secondary/10 rounded-2xl flex items-center justify-center icon-float">
                                <svg class="w-8 h-8 text-secondary" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9 4.804A7.968 7.968 0 005.5 4c-1.255 0-2.443.29-3.5.804v10A7.969 7.969 0 015.5 14c1.669 0 3.218.51 4.5 1.385A7.962 7.962 0 0114.5 14c1.255 0 2.443.29 3.5.804v-10A7.968 7.968 0 0014.5 4c-1.255 0-2.443.29-3.5.804V12a1 1 0 11-2 0V4.804z"/>
                                </svg>
                            </div>
                            <span class="px-4 py-2 bg-secondary/10 text-secondary text-sm font-medium rounded-full">Literasi</span>
                        </div>
                        
                        <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Perpustakaan</h2>
                        <p class="text-gray-600 mb-6 leading-relaxed text-lg">
                            Perpustakaan dengan koleksi lengkap untuk menumbuhkan minat baca dan literasi siswa. Ruangan yang nyaman dengan koleksi buku yang terus diperbarui.
                        </p>
                        
                        <div class="space-y-4">
                            <div class="feature-item flex items-start gap-4">
                                <div class="flex-shrink-0 w-8 h-8 bg-secondary rounded-full flex items-center justify-center mt-1">
                                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                    </svg>
                                </div>
                            ...
                            <div class="feature-item flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm">Akses mudah untuk meminjam dan mengembalikan buku</p>
                                </div>
                            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="gallery-image h-64">
                    <img src="{{ asset('img/gallery-fasilitas-1.jpg') }}" alt="Fasilitas 1" class="w-full h-full object-cover">
                ...
                <div class="gallery-image h-64">
                    <img src="{{ asset('img/gallery-fasilitas-2.jpg') }}" alt="Fasilitas 2" class="w-full h-full object-cover">
                    <div class="gallery-overlay">
                ...
                <div class="gallery-image h-64">
                    <img src="{{ asset('img/gallery-fasilitas-3.jpg') }}" alt="Fasilitas 3" class="w-full h-full object-cover">
                    <div class="gallery-overlay">
                ...
                <div class="gallery-image h-64">
                    <img src="{{ asset('img/gallery-fasilitas-4.jpg') }}" alt="Fasilitas 4" class="w-full h-full object-cover">
                    <div class="gallery-overlay">
                ...
                <div class="gallery-image h-64">
                    <img src="{{ asset('img/gallery-fasilitas-5.jpg') }}" alt="Fasilitas 5" class="w-full h-full object-cover">
                    <div class="gallery-overlay">
                        <p class="text-white font-semibold">Ruang Serbaguna</p>
                    </div>
                </div>
                ...
                <div class="gallery-image h-64">
                    <img src="{{ asset('img/gallery-fasilitas-6.jpg') }}" alt="Fasilitas 6" class="w-full h-full object-cover">
                    <div class="gallery-overlay">
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div class="text-center">
                    <div class="w-20 h-20 mx-auto mb-4 bg-accent-orange/10 rounded-2xl flex items-center justify-center">
                ...
                <div class="text-center">
                    <div class="w-20 h-20 mx-auto mb-4 bg-accent-yellow/10 rounded-2xl flex items-center justify-center">
