                    ...
                    <div class="card bg-primary text-white shadow stat-card-custom h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="text-white fw-bold text-uppercase mb-1">Kelas Diampu</div>
                                    <div class="h2 fw-bold mb-0 text-white">{{ $kelasYangDiajar->count() ?? 0 }}</div>
                                    <div class="text-white">Kelas aktif</div>
                                </div>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card bg-success text-white shadow stat-card-custom h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="text-white fw-bold text-uppercase mb-1">Total Siswa</div>
                                    <div class="h2 fw-bold mb-0 text-white">{{ $totalSiswa ?? 0 }}</div>
                                    <div class="text-white">Siswa diajar</div>
                                </div>
                ...
                <div class="col-xl-4 col-md-12 mb-4">
                    <div class="card bg-warning text-white shadow stat-card-custom h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="text-white fw-bold text-uppercase mb-1">Jadwal Hari Ini</div>
                                    <div class="h2 fw-bold mb-0 text-white">{{ $jadwalHariIni->count() ?? 0 }}</div>
                                    <div class="text-white">Jam mengajar</div>
                                </div>
                        ...
                        <div class="card-body">
                            @if(isset($kelasYangDiajar) && $kelasYangDiajar->count())
                                @foreach($kelasYangDiajar as $item)
                                    <div
                                        class="p-3 mb-2 border-start border-info border-4 rounded kelas-item d-flex justify-content-between align-items-center">
                                        <div>
                                            <div class="fw-bold text-gray-800 fs-5">{{ $item['kelas']->nama_kelas }}</div>
