        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden mb-8 relative z-10">
                <div class="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
                    ...
                    <a href="https://wa.me/6285811258534" target="_blank"
                        class="group relative p-10 text-center transition-all duration-300 hover:bg-green-50/50">
                        <div
                            class="absolute top-0 left-0 w-full h-1 bg-green-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300">
                        </div>
                        <div
                            class="w-16 h-16 mx-auto mb-6 bg-green-100 text-green-600 rounded-2xl flex items-center justify-center group-hover:bg-green-600 group-hover:text-white group-hover:scale-110 transition-all duration-300">
                        ...
                        <div
                            class="inline-flex items-center gap-2 text-green-600 font-semibold group-hover:gap-3 transition-all mb-3">
                    ...
                    <a href="tel:02174427521"
                        class="group relative p-10 text-center transition-all duration-300 hover:bg-blue-50/50">
                        <div
                        ...
                        <div
                            class="w-16 h-16 mx-auto mb-6 bg-blue-100 text-primary rounded-2xl flex items-center justify-center group-hover:bg-primary group-hover:text-white group-hover:scale-110 transition-all duration-300">
                        ...
                        <div
                            class="inline-flex items-center gap-2 text-primary font-semibold group-hover:gap-3 transition-all mb-3">
                            <span>+62 858-1125-8534</span>
                        </div>
                        <p class="text-gray-500 text-sm">Senin - Jumat: 08:00 - 14:00</p>
                    </a>

                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=hokhomeschool@gmail.com" target="_blank"
                        class="group relative p-10 text-center transition-all duration-300 hover:bg-green-50/50">
                        <div
                            class="absolute top-0 left-0 w-full h-1 bg-secondary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300">
                        </div>
                        <div
                            class="w-16 h-16 mx-auto mb-6 bg-green-100 text-secondary rounded-2xl flex items-center justify-center group-hover:bg-secondary group-hover:text-white group-hover:scale-110 transition-all duration-300">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div
                            class="inline-flex items-center gap-2 text-secondary font-semibold group-hover:gap-3 transition-all mb-3">
