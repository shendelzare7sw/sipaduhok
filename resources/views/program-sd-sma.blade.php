...
<head>
    ...
    <style>
        ...
        .tab-btn.active { background-color: #165fac; color: white; }
...
<section class="relative h-[350px] flex items-center justify-center" 
    ...
    <div class="relative z-10 text-center text-white px-4">
        <nav class="text-sm mb-4">
            ...
            <span class="font-semibold">Program Pendidikan</span>
        </nav>
        <h1 class="text-4xl md:text-5xl font-bold">Program Pendidikan Kesetaraan</h1>
        <p class="mt-4 text-white/90">Paket A • Paket B • Paket C</p>
    </div>
</section>
...
<div id="tab-sd" class="tab-content">
    @include('partials.program-sd-content')
</div>

<!-- SMP • Paket B -->
<div id="tab-smp" class="tab-content hidden">
    @include('partials.program-smp-content')
</div>

<!-- SMA • Paket C -->
<div id="tab-sma" class="tab-content hidden">
    @include('partials.program-sma-content')
</div>
