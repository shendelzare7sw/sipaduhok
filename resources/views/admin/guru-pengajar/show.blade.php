                ...
                <div class="header-info">
                    ...
                    <div class="header-text">
                        ...
                        <div class="header-meta">
                            ...
                            <span class="header-badge">
                                <i class="fas fa-user-tag"></i> {{ ucfirst(str_replace('_', ' ', $guruPengajar->user->role ?? '-')) }}
                            </span>
                            <span class="header-badge">
                                <i class="fas fa-circle" style="font-size: 8px; color: {{ $guruPengajar->user->is_active ? '#4ade80' : '#f87171' }}"></i>
    ...
    <div class="card">
        <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <form action="" method="GET" style="display: flex; gap: 10px;">
                <select name="tahun_ajaran_id" onchange="this.form.submit()" style="padding: 8px 14px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 13px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <form action="{{ route('admin.guru-pengajar.remove-assignment', $guruPengajar) }}" method="POST" style="display: inline;" id="deleteForm{{ $assignment->id }}">
                                        @csrf
                                        <input type="hidden" name="assignment_id" value="{{ $assignment->id }}">
                                        <button type="button" class="btn btn-danger btn-sm" title="Hapus" onclick="confirmDeletePenugasan('{{ $assignment->id }}', '{{ $assignment->kelas->nama_kelas }}', '{{ $assignment->mataPelajaran->nama_mapel }}')">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border: none; border-radius: 16px; overflow: hidden;">
            ...
            <div class="modal-body" style="padding: 24px;">
                <p style="margin-bottom: 16px; color: #374151; font-size: 15px;">Apakah Anda yakin ingin menghapus penugasan berikut?</p>
                ...
                <p style="color: #6b7280; font-size: 14px; margin: 0;">
                    <i class="fas fa-info-circle"></i> Guru tidak akan lagi mengajar mata pelajaran ini di kelas tersebut.
                </p>
            </div>
