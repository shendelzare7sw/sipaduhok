            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('admin.pengaturan-istirahat.toggle-status', $pengaturan) }}" method="POST" class="d-inline">
                                @csrf
                                @method('PATCH')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('admin.pengaturan-istirahat.destroy', $pengaturan) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
