    ...
    <div class="row justify-content-center">
        <div class="col-xl-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.pengaturan-istirahat.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('jenjang') is-invalid @enderror" id="jenjang" name="jenjang"
                                {{ $selectedJenjang ? 'disabled' : '' }} required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_istirahat') is-invalid @enderror"
                                id="nama_istirahat" name="nama_istirahat" value="{{ old('nama_istirahat') }}"
                                placeholder="Contoh: Istirahat 1, Istirahat 2, Istirahat Siang, dll" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('urutan') is-invalid @enderror" id="urutan" name="urutan"
                                required>
                                ...
                                @foreach($hariList as $hari)
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="hari_aktif[]"
                                            id="hari_{{ $hari }}" value="{{ $hari }}" {{ in_array($hari, old('hari_aktif', [])) ? 'checked' : '' }}>
            ...
            <div class="card mt-4">
                <div class="card-body">
                    ...
                    <ul class="mb-0">
                        ...
                        @if($selectedJenjang)
                            <li><i class="fas fa-lock text-success me-1"></i> Jenjang sudah dikunci untuk
                                <strong>{{ $selectedJenjang }}</strong></li>
                        @endif
                        <li><strong>Urutan istirahat:</strong> Maksimal 2 urutan (Istirahat 1 dan Istirahat 2) per jenjang
                        </li>
                        <li><strong>Hari yang berbeda:</strong> Anda bisa membuat istirahat dengan urutan yang sama tapi
                            untuk hari yang berbeda
                            <br><small class="text-muted">Contoh: Istirahat 1 untuk Senin-Kamis (09:00-09:15), dan Istirahat
                                1 untuk Jumat (10:00-10:15)</small>
                        </li>
