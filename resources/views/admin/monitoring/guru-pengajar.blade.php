{{-- resources/views/admin/monitoring/guru-pengajar.blade.php --}}
    ...
    <div style="max-width: 1400px; margin: 0 auto; padding: 0 1rem;">
        <div class="card">
            <div class="card-header"
                ...
                <form action="{{ route('admin.monitoring.guru-pengajar') }}" method="GET" class="filter-group" style="display: flex; gap: 12px; align-items: center;">
                    <!-- Search -->
                    ...
                    @if(request()->anyFilled(['search', 'cabang_id']))
                        <a href="{{ route('admin.monitoring.guru-pengajar') }}" class="btn btn-secondary btn-sm"><i class="fas fa-undo"></i> Reset</a>
                    @endif
                </form>
            </div>
            <div class="card-body">
