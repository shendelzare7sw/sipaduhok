...
<div style="max-width: 1400px; margin: 0 auto; padding: 0 1rem;">
    <div class="card">
        <div class="card-header">
            ...
            <form action="{{ route('admin.monitoring.siswa') }}" method="GET" class="filter-group">
                <!-- Search -->
                ...
                @if(request()->anyFilled(['search', 'cabang_id', 'kelas_id']))
                    <a href="{{ route('admin.monitoring.siswa') }}" class="btn btn-secondary btn-sm"><i class="fas fa-undo"></i> Reset</a>
                @endif
            </form>
        </div>
        <div class="card-body">
