...
@section('styles')
    @vite('resources/css/admin/catatan/index.css')
@endsection
...
@section('scripts')
    <template id="catatanDeleteConfig" data-base-path="/admin/catatan"></template>
    @vite('resources/js/admin/catatan/index.js')
@endsection
