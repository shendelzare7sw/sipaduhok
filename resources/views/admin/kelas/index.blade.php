...
@section('styles')
    @vite(['resources/css/admin/kelas/index.css'])
@endsection
        ...
        <form action="{{ route('admin.kelas.index') }}" method="GET" class="mb-0">
            <div class="filter-wrapper">
                ...
                @if(request()->hasAny(['search', 'jenjang', 'cabang_id']) || (request('tahun_ajaran_id') && request('tahun_ajaran_id') != $currentTahunAjaran?->id))
                    <a href="{{ route('admin.kelas.index') }}" class="btn btn-outline-danger btn-sm px-3 btn-reset">
                        ...
                        <td class="td-actions text-end" data-label="Aksi">
                            <div class="d-flex justify-content-end gap-1 action-btns">
                                ...
                                <button type="button"
                                        ...
                                        data-delete-kelas
                                        data-delete-url="{{ route('admin.kelas.destroy', $k->id) }}"
        ...
        <div class="modal-content border-0 shadow">
            ...
            <form action="{{ route('admin.kelas.copy') }}" method="POST">
                ...
                <div class="modal-body px-4 py-4">
                    <div class="alert alert-info py-2 px-3 mb-4 rounded border-0 copy-alert">
...
@section('scripts')
    @vite(['resources/js/admin/kelas/index.js'])
@endsection
