...
@section('styles')
    @vite(['resources/css/admin/kelas/show.css'])
@endsection
            ...
            <div class="card-body">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <a href="{{ route('admin.kelas.edit', $kelas) }}" class="btn btn-success empty-action">
        ...
        <div class="card-body">
            ...
            @else
                <div class="empty-state">
                    ...
                    <a href="{{ route('admin.kelas.manage-siswa', $kelas) }}" class="btn btn-success empty-action">
