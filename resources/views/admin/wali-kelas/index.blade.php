        ...
        <form action="{{ route('admin.wali-kelas.index') }}" method="GET" class="mb-0">
            <div class="filter-wrapper">
                ...
                @if(request()->hasAny(['search', 'jenjang', 'cabang_id', 'status']) || (request('tahun_ajaran_id') && request('tahun_ajaran_id') != $currentTahunAjaran?->id))
                    <a href="{{ route('admin.wali-kelas.index', ['tahun_ajaran_id' => request('tahun_ajaran_id')]) }}" class="btn btn-outline-danger btn-sm px-3" style="border-radius: 8px;">
                ...
                <div class="modal-body px-4 py-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <select id="filterCabang" class="form-select" style="max-width: 140px; border-radius: 8px;">
                                <option value="">Semua Cabang</option>
                                ...
                                @foreach($waliKelasOptions as $wk)
                                    ...
                                    <div class="wali-option d-flex align-items-center gap-3"
                                        ...
                                        <div style="flex: 1; line-height: 1.2;">
                                            ...
                                            <div class="text-muted" style="font-size: 0.75rem;"><i class="fas fa-building me-1"></i>{{ $wk->user->cabang->nama_cabang ?? '-' }}</div>
...
function filterWaliList() {
    ...
    waliOptions.forEach(option => {
        ...
        option.classList.toggle('d-none', !(matchSearch && matchCabang));
