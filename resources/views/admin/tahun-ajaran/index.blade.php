...
@section('content')
    ...
    <div class="alert alert-primary d-flex justify-content-between align-items-center mb-4 border-0 shadow-sm" style="background: #eff6ff; color: #1e3a8a; border-radius: 10px;">
        ...
        <a href="{{ route('admin.tahun-ajaran.index') }}" class="btn btn-sm btn-light text-primary fw-bold" style="border-radius: 6px;">
    ...
    <div class="ta-card">
        <div class="ta-card-header">
            ...
            <div class="filter-wrapper">
                ...
                <a href="{{ route('admin.tahun-ajaran.create') }}" class="btn btn-primary d-flex align-items-center gap-2" style="border-radius: 8px;">
