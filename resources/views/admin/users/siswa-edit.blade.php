    ...
    <div class="card">
        ...
        <div class="form-group">
            ...
            <div style="position: relative;">
                <input type="password" id="passwordField" name="password" class="form-control" placeholder="Masukkan password baru (opsional)" style="padding-right: 45px;">
    ...
    <div class="card">
        ...
        <div id="addExistingParentForm" style="display: none; margin-top: 12px;">
                ...
                <div id="parentListContainer" style="max-height: 300px; overflow-y: auto; border: 1px solid #cbd5e1; border-radius: 8px; padding: 8px;">
                    @foreach($orangTuaList as $ortu)
                        ...
                        <label class="parent-option"
                            ...
                            <input type="radio" name="add_existing_parent_id" value="{{ $ortu->id }}" style="margin-right: 12px;" {{ $isAlreadyLinked ? 'disabled' : '' }}>
                            <div style="flex: 1;">
            ...
            <div class="form-group">
                ...
                <select name="add_existing_relationship" class="form-control" id="add_existing_relationship" onchange="toggleAddExistingRelationship()">
            ...
            <div id="addExistingRelationshipOtherField" style="display: none;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="add_existing_relationship_lainnya" placeholder="Contoh: Kakek, Nenek, Paman, Bibi, dll">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            <input type="password" id="newParentPasswordField" name="add_new_parent_password" class="form-control" placeholder="Minimal 8 karakter" style="padding-right: 45px;">
                            <button type="button" onclick="togglePassword('newParentPasswordField', 'toggleNewParentPasswordIcon')" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #64748b; padding: 5px;">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select name="add_new_relationship" class="form-control" id="add_new_relationship" onchange="toggleAddNewRelationship()">
                            <option value="ayah_kandung">Ayah Kandung</option>
                            <option value="ibu_kandung">Ibu Kandung</option>
                            <option value="wali">Wali</option>
                            <option value="ayah_tiri">Ayah Tiri</option>
                    ...
                    <div id="addNewRelationshipOtherField" style="display: none;">
                        <div class="form-group">
                            <label class="form-label">Sebutkan Hubungan Keluarga Lainnya</label>
                            <input type="text" class="form-control" name="add_new_relationship_lainnya" placeholder="Contoh: Kakek, Nenek, Paman, Bibi, dll">
                        </div>
                    </div>
                </div>
            </div>
