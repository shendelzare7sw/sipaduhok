...
<div class="info-box">
    ...
    <div>
        <strong>Catatan:</strong> Gunakan form ini untuk mengubah data akun orang tua. Data siswa yang terhubung dengan orang tua ini tidak akan terpengaruh.
    </div>
</div>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name', $orangTua->name) }}" placeholder="Masukkan nama lengkap" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label class="form-label">Username <span style="color: #ef4444;">*</span></label>
                    <input type="text" name="username" class="form-control" value="{{ old('username', $orangTua->username) }}" placeholder="Masukkan username" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" value="{{ old('email', $orangTua->email) }}" placeholder="contoh@email.com">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label class="form-label">No. Telepon/WA <small class="text-muted">(Opsional)</small></label>
                    <input type="text" name="phone" class="form-control" value="{{ old('phone', $orangTua->phone) }}" placeholder="Contoh: 08123456789">
