...
<div class="container-fluid">
    ...
    <div class="info-box">
        ...
        <div>
            <strong>Panduan:</strong> Isi semua field yang bertanda <span style="color: #ef4444;">*</span> (wajib diisi). Anda dapat menghubungkan akun ini dengan siswa yang sudah ada (opsional).
        </div>
    </div>

    <form action="{{ route('admin.users.orang-tua.store') }}" method="POST" id="orangTuaCreateForm" onsubmit="return validateForm()">
        @csrf
        ...
        <div class="card">
            ...
            <div class="info-box" style="background: #fef3c7; border-color: #fde68a; color: #92400e;">
                ...
                <div>
                    <strong>Info:</strong> Anda dapat menghubungkan akun orang tua ini dengan siswa yang sudah terdaftar. Jika tidak dihubungkan sekarang, Anda dapat menghubungkannya nanti melalui menu edit siswa.
                </div>
            </div>
            ...
            <div class="student-link-section">
                ...
                <div style="margin-bottom: 12px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                        ...
                        <button type="button" onclick="resetFilters()" style="background: none; border: none; color: #3b82f6; font-size: 13px; cursor: pointer; padding: 4px 8px; display: inline-flex; align-items: center; gap: 4px;">
                        ...
                        <div class="form-group">
                            <select id="filterKelas" class="form-control" onchange="filterStudentList()">
                                ...
                                @foreach($kelasList as $kelas)
                                    <option value="{{ $kelas->nama_kelas }}">{{ $kelas->jenjang }} - {{ $kelas->nama_kelas }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div style="max-height: 300px; overflow-y: auto; border: 1px solid #e5e7eb; border-radius: 8px; padding: 8px; background: white;">
                ...
                <div class="form-group" style="margin-top: 16px;">
                    ...
                    <select class="form-control" id="hubungan_keluarga" name="hubungan_keluarga" onchange="toggleOtherRelationshipCreate()">
                ...
                <div id="otherRelationshipCreateField" style="display: none; margin-top: 12px;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="hubungan_keluarga_lainnya" name="hubungan_keluarga_lainnya" placeholder="Contoh: Kakek, Nenek, Paman, Bibi, dll">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="custom-modal">
            ...
            <div class="custom-modal-body">
                ...
                <ul>
                    ...
                    <li><strong>Batal Pilih Hubungan:</strong> Kosongkan pilihan hubungan keluarga jika tidak ingin menghubungkan dengan siswa</li>
                </ul>
            </div>
