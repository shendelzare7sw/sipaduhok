...
<style>
    ...
    .card-header { padding: 20px; border-bottom: 1px solid #e5e7eb; display: flex; justify-content: space-between; align-items: center; background: white; border-radius: 12px 12px 0 0; }
    ...
    .btn-secondary { background: white; border: 1px solid #e2e8f0; color: #475569; padding: 8px 16px; border-radius: 6px; text-decoration: none; font-size: 14px; transition: all 0.2s; display: inline-flex; align-items: center; gap: 6px; }
    ...
    .badge-role { background: #e0f2fe; color: #0284c7; }
        ...
        <div style="overflow-x: auto;">
            <table class="table" style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="text-align: center; font-weight: 600; color: #64748b;">{{ $tenagaPendidik->firstItem() + $index }}</td>
                        <td>
                        ...
                        <td>
                            <span style="font-family: 'Courier New', monospace; color: #475569;">{{ $tp->nip ?? '-' }}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            <div style="display: flex; justify-content: center; gap: 6px;">
                                {{-- View Button --}}
                                <a href="{{ route('admin.users.show-tenaga-pendidik', $tp->id) }}" class="action-btn view" title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                {{-- Edit Button --}}
                                <a href="{{ route('admin.users.edit-tenaga-pendidik', $tp->id) }}" class="action-btn edit" title="Edit Data">
                                    <i class="fas fa-edit"></i>
                                </a>
                                {{-- Delete Button --}}
                                <button type="button" class="action-btn delete" title="Hapus Data" data-bs-toggle="modal" data-bs-target="#deleteTenagaPendidikModal{{ $tp->id }}">
                    ...
                    <tr>
                        <td colspan="7" style="text-align: center; padding: 40px; color: #94a3b8;">
                            ...
                            <small>
                                @if(request('search'))
                                    Coba kata kunci lain atau <a href="{{ route('admin.users.tenaga-pendidik') }}" style="color: #2563eb; text-decoration: underline;">hapus filter</a>
                                @else
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div style="background: #f9fafb; padding: 12px; border-radius: 8px; margin: 12px 0; border: 1px solid #e5e7eb;">
                    ...
                    <small style="color: #64748b;">{{ $tp->user->role ? ucwords(str_replace('_', ' ', $tp->user->role)) : '-' }} • {{ $tp->email }}</small>
                </div>
            ...
            <div class="modal-footer bg-light">
                ...
                <form action="{{ route('admin.users.delete-tenaga-pendidik', $tp->id) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
