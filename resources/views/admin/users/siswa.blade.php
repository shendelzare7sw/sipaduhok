...
<style>
    ...
    .badge-status.lulus { background: #dbeafe; color: #1e40af; }
        ...
        <div style="overflow-x: auto;">
            <table class="table" style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="text-align: center; font-weight: 600; color: #64748b;">{{ $siswa->firstItem() + $index }}</td>
                        <td>
                            <div style="font-weight: 600; color: #111827;">{{ $s->nama_lengkap }}</div>
                            <small style="color: #64748b;">
                                <i class="fas fa-{{ $s->jenis_kelamin == 'L' ? 'mars' : 'venus' }}" style="font-size: 10px;"></i>
                        ...
                        <td>
                            <div style="display: flex; justify-content: center; gap: 6px;">
                                {{-- View Button --}}
                                <a href="{{ route('admin.users.show-siswa', $s->id) }}" class="action-btn view" title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                {{-- Edit Button --}}
                                <a href="{{ route('admin.users.edit-siswa', $s->id) }}" class="action-btn edit" title="Edit Data">
                                    <i class="fas fa-edit"></i>
                                </a>
                                {{-- Delete Button --}}
                                <button type="button" class="action-btn delete" title="Hapus Data" data-bs-toggle="modal" data-bs-target="#deleteSiswaModal{{ $s->id }}">
