...
@section('content')
    ...
    <div style="max-width:800px;margin:0 auto;padding:0 1rem">
        ...
        <div class="instructions">
            <h6><i class="fas fa-info-circle"></i> Petunjuk Import Tenaga Pendidik</h6>
            <ol>
                <li>Download template Excel berisi referensi role dan cabang</li>
                <li>Isi data. Kolom <strong>nama_lengkap</strong> wajib diisi</li>
                <li>Role harus sesuai: guru_pengajar, wali_kelas, dll</li>
        ...
        <div class="card">
            <div class="card-header">
                <h5><i class="fas fa-file-import" style="color:#7c3aed;margin-right:10px"></i>Upload File Excel</h5>
            </div>
            <div class="card-body">
                <div style="margin-bottom:24px;padding-bottom:24px;border-bottom:1px solid #e5e7eb">
                    <a href="{{ route('admin.users.tenaga-pendidik-template') }}" class="btn btn-success"><i
                            class="fas fa-download"></i> Download Template</a>
                </div>
                <form action="{{ route('admin.users.import-tenaga-pendidik.store') }}" method="POST"
                    ...
                    <div class="file-selected" id="fileSelected">
                        <div style="display:flex;align-items:center;gap:10px">
                            <i class="fas fa-file-excel" style="color:#7c3aed;font-size:24px"></i>
                    ...
                    <div style="display:flex;gap:12px;margin-top:24px">
                        <a href="{{ route('admin.users.tenaga-pendidik') }}" class="btn btn-secondary"><i
