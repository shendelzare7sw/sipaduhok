...
<div class="info-box">
    ...
    <div>
        <strong>Panduan:</strong> Isi semua field yang bertanda <span style="color: #ef4444;">*</span> (wajib diisi). Data siswa yang sudah tersimpan dapat diubah kapan saja melalui menu edit.
    </div>
</div>
...
<form action="{{ route('admin.users.store-siswa') }}" method="POST">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <input type="password" id="passwordField" name="password" class="form-control" required style="padding-right: 45px;" placeholder="Minimal 8 karakter">
                        <button type="button" onclick="togglePassword('passwordField', 'togglePasswordIcon')" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #64748b; padding: 5px;">
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" name="tempat_lahir" class="form-control" value="{{ old('tempat_lahir') }}" placeholder="Kota tempat lahir" required>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
    ...
    <div class="card">
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_ayah" class="form-control" value="{{ old('nama_ayah') }}" placeholder="Masukkan nama ayah kandung">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label class="form-label">Nama Ibu</label>
                    <input type="text" name="nama_ibu" class="form-control" value="{{ old('nama_ibu') }}" placeholder="Masukkan nama ibu kandung">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="telepon_orangtua" class="form-control" value="{{ old('telepon_orangtua') }}" placeholder="Contoh: 08123456789">
    ...
    <div class="card">
        ...
        <div id="existingParentForm" style="display: none;">
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" id="searchParent" class="form-control" placeholder="Ketik nama atau username orang tua...">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
            ...
            <div class="form-group" style="margin-top: 12px;">
                ...
                <div id="parentListContainer" style="max-height: 300px; overflow-y: auto; border: 1px solid #cbd5e1; border-radius: 8px; padding: 8px;">
                    @foreach($orangTuaList as $ortu)
                        @php
                            $hasChildren = $ortu->studentParents->count() > 0;
                        @endphp
                        <label class="parent-option"
                               data-name="{{ strtolower($ortu->name) }}"
                            ...
                            <div style="flex: 1;">
                                <div style="font-weight: 600; color: #111827; display: flex; align-items: center; gap: 8px;">
                                    ...
                                    {{ $ortu->name }}
                                    @if(!$hasChildren)
                                        <span style="background: #dbeafe; color: #1e40af; padding: 2px 8px; border-radius: 4px; font-size: 11px; font-weight: 600;">BARU</span>
                                    @endif
                                </div>
                                <small style="color: #64748b;">
                                    Username: {{ $ortu->username }}
                                    @if($hasChildren)
                                        • <strong>Anak:</strong> {{ $ortu->studentParents->pluck('siswa.nama_lengkap')->join(', ') }}
                                    @else
            ...
            <div class="form-group">
                ...
                <select name="existing_relationship" class="form-control" id="existing_relationship" onchange="toggleExistingRelationship()">
            ...
            <div id="existingRelationshipOtherField" style="display: none;">
                <div class="form-group">
                    <label class="form-label">Sebutkan Hubungan Keluarga Lainnya <span style="color: #ef4444;">*</span></label>
                    <input type="text" class="form-control" name="existing_relationship_lainnya" placeholder="Contoh: Kakek, Nenek, Paman, Bibi, dll">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="parent_name" class="form-control" value="{{ old('parent_name') }}" placeholder="Nama lengkap orang tua">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label class="form-label">Username Orang Tua <span style="color: #ef4444;">*</span></label>
                        <input type="text" name="parent_username" class="form-control" value="{{ old('parent_username') }}" placeholder="Username untuk login">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="email" name="parent_email" class="form-control" value="{{ old('parent_email') }}" placeholder="contoh@email.com">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label class="form-label">Password <span style="color: #ef4444;">*</span></label>
                        <div style="position: relative;">
                            <input type="password" id="parentPasswordField" name="parent_password" class="form-control" style="padding-right: 45px;" placeholder="Minimal 8 karakter">
                            <button type="button" onclick="togglePassword('parentPasswordField', 'toggleParentPasswordIcon')" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #64748b; padding: 5px;">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <select name="new_relationship" class="form-control" id="new_relationship" onchange="toggleNewRelationship()">
                            <option value="ayah_kandung">Ayah Kandung</option>
                            <option value="ibu_kandung">Ibu Kandung</option>
                            <option value="wali">Wali</option>
                            <option value="ayah_tiri">Ayah Tiri</option>
                    ...
                    <div id="newRelationshipOtherField" style="display: none;">
                        <div class="form-group">
                            <label class="form-label">Sebutkan Hubungan Keluarga Lainnya <span style="color: #ef4444;">*</span></label>
                            <input type="text" class="form-control" name="new_relationship_lainnya" placeholder="Contoh: Kakek, Nenek, Paman, Bibi, dll">
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" name="parent_phone" class="form-control" value="{{ old('parent_phone') }}" placeholder="Contoh: 08123456789">
                    </div>
                </div>
            </div>
            <div class="form-group">
