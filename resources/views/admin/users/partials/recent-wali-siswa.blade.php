<div class="usr-card">
    <div class="usr-card-header">
        <div>
            ...
            <div class="usr-card-subtitle">{{ $orangTua->count() }} data wali siswa yang baru ditambahkan</div>
        </div>
        <div>
            @if($orangTua->count() > 0)
                <a href="{{ route('admin.users.wali-siswa') }}" class="btn-outline-action">
                    Lihat Semua <i class="fas fa-arrow-right icon-ms"></i>
                </a>
            @else
                <a href="{{ route('admin.users.wali-siswa') }}" class="btn-primary-action">
                    <i class="fas fa-arrow-right icon-me"></i> Kelola Wali Siswa
                </a>
            @endif
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="mobile-card-actions">
                                    <div class="action-btns">
                                        <a href="{{ route('admin.users.wali-siswa') }}"
