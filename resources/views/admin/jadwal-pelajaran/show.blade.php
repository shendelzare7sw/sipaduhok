...
@section('styles')
@vite(['resources/css/admin/jadwal-pelajaran/show.css'])
@endsection
                ...
                @foreach($hariList as $hari)
                    ...
                    @if($jadwalForSlot)
                        <div class="schedule-cell has-schedule"
                             data-schedule-href="{{ route('admin.jadwal-pelajaran.edit', $jadwalForSlot) }}">
...
@section('scripts')
@vite(['resources/js/admin/jadwal-pelajaran/show.js'])
@endsection
