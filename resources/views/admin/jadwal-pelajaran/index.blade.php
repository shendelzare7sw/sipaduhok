...
<div class="stat-row">
        ...
        <div class="jp-card-header">
            ...
            <div class="btn-scroll-mobile">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                        <li><a class="dropdown-item" href="{{ route('admin.jadwal-pelajaran.export-pdf', request()->query()) }}" target="_blank">
                            <i class="fas fa-file-pdf me-2 text-danger"></i> Export PDF (Semua)</a></li>
                        <li><a class="dropdown-item" href="{{ route('admin.jadwal-pelajaran.export-excel', request()->query()) }}">
    ...
    @foreach($jadwalList as $jadwal)
        ...
        <div class="modal fade" id="gantiGuruModal{{ $jadwal->id }}" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered jp-dialog-md">
                <form action="{{ route('admin.jadwal-pelajaran.ganti-guru', $jadwal) }}" method="POST" class="jp-form-full">
                    @csrf
    ...
    <div id="jp-config"
        data-bulk-update-status-url="{{ route('admin.jadwal-pelajaran.bulk-update-status') }}"
        data-bulk-delete-url="{{ route('admin.jadwal-pelajaran.bulk-delete') }}"
        data-csrf-token="{{ csrf_token() }}"
        data-current-tahun-ajaran-id="{{ request('tahun_ajaran_id', $currentTahunAjaran?->id) }}"
        data-export-excel-base-url="{{ url('admin/jadwal-pelajaran/kelas') }}"
        data-print-base-url="{{ url('admin/jadwal-pelajaran/kelas') }}"></div>
            ...
            <div class="modal-content border-0 shadow jp-modal">
                ...
                <div class="modal-body px-4 py-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="printCabangId" class="form-select" data-filter-print-kelas>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="printKelasId" class="form-select" disabled>
                            ...
                            @foreach($allKelasList as $kelas)
                                <option value="{{ $kelas->id }}" data-cabang="{{ $kelas->cabang_id }}" class="jp-hidden-option">
