...
@section('styles')
    @vite(['resources/css/admin/akademik/kalender/show.css'])
@endsection
...
<div class="admin-calendar-show-page">
<div class="card shadow-lg border-0">
    <div class="card-header bg-primary text-white">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="m-0 fw-bold text-white">{{ $kalender->nama_kegiatan }}</h5>
            <div class="btn-group" role="group">
                <a href="{{ route('admin.akademik.kalender.edit', $kalender->id) }}" class="btn btn-warning btn-sm shadow-sm">
                ...
                <a href="{{ route('admin.akademik.kalender.index') }}" class="btn btn-secondary btn-sm shadow-sm">
...
@section('scripts')
    @vite(['resources/js/admin/akademik/kalender/show.js'])
@endsection
