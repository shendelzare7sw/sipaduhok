    ...
    <div class="bulk-create-page">
        <div class="container-fluid px-0">
                    ...
                    <div>
                        ...
                        <p class="mb-0 mt-2">
                            ...
                            Untuk tagihan <strong>SPP Bulanan</strong>, gunakan fitur <a
                                href="{{ route('admin.keuangan.tagihan.generate-spp') }}"
                                class="alert-link fw-bold">"Generate SPP"</a> yang lebih akurat.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.keuangan.tagihan.bulk-create') }}" method="POST">
                        @csrf
