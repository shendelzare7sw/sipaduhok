...
<div class="container-fluid px-0">
            ...
            <form action="{{ route('admin.keuangan.tagihan.index') }}" method="GET">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <a href="{{ route('admin.keuangan.tagihan.index') }}" class="btn btn-light btn-sm border px-3 ms-1 fw-bold text-gray-700">
    ...
    <div class="row align-items-center mb-3">
        ...
        <div class="col-md-6 text-end">
            <a href="{{ route('admin.keuangan.tagihan.bulk-create') }}" class="btn btn-success btn-sm shadow-sm fw-bold px-4 py-2">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="btn-group shadow-sm">
                                            <a href="{{ route('admin.keuangan.tagihan.show', $siswa->id) }}" class="btn btn-sm btn-info" title="Lihat Detail">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.keuangan.tagihan.edit', $siswa->id) }}" class="btn btn-sm btn-warning" title="Edit Tagihan">
