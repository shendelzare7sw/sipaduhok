            ...
            <form action="{{ route('admin.keuangan.pembayaran.index') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2 text-end align-self-end">
                        ...
                        <a href="{{ route('admin.keuangan.pembayaran.index') }}" class="btn btn-light btn-sm border px-3 ms-2 fw-bold text-gray-800">
                            ...
                            @foreach($pembayaranList as $index => $pembayaran)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="{{ route('admin.keuangan.pembayaran.show', $pembayaran->id) }}" class="btn btn-info btn-sm rounded-circle shadow-sm" title="Validasi / Detail">
