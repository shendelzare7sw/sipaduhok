...
@section('styles')
    @vite(['resources/css/admin/keuangan/pembayaran/create.css'])
@endsection

@section('content')
<div class="pembayaran-create-page">
<div class="container-fluid px-0">
        ...
        <div class="d-flex">
            ...
            <div>
                ...
                <ul class="mb-0 mt-2">
                    ...
                    <li>Pembayaran digital dan <strong>Direct Transfer</strong> akan otomatis tercatat dari sistem wali siswa</li>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.keuangan.pembayaran.store', $siswa->id) }}" method="POST" enctype="multipart/form-data" data-payment-form>
                @csrf
                ...
                <div class="row">
                                                ...
                                                <div class="nominal-wrapper">
                                                    ...
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="text" 
                                                               ...
                                                               class="form-control form-control-sm text-end currency-input nominal-input {{ $tagihan->jenis_tagihan === 'spp' ? 'nominal-input-readonly' : '' }}"
                                                               value="{{ number_format($tagihan->sisa_per_item, 0, ',', '.') }}"
                                                               data-id="{{ $tagihan->id }}"
                                                               data-max="{{ $tagihan->sisa_per_item }}"
                                                               @if($tagihan->jenis_tagihan === 'spp') readonly @endif>
                                                    </div>
                                                    @if($tagihan->jenis_tagihan === 'spp')
                                                        <small class="text-muted fst-italic spp-note">SPP tidak dapat dicicil</small>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-control shadow-sm bg-light payment-method-display">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jumlah_bayar_display" id="jumlah_bayar_display"
                                   class="form-control shadow-sm payment-total-input"
                        ...
                        <div class="p-3 rounded border border-primary border-2 mb-3" style="background-color: rgba(67, 97, 238, 0.1);">
                            ...
                            <div class="d-flex justify-content-between fs-5 fw-bold text-primary pt-2 border-top border-primary border-2 summary-total-line">
                        ...
                        <div>
                            <button type="submit" class="btn btn-primary w-100 shadow-sm fw-bold" data-submit-payment {{ $tagihanBelumLunas->count() == 0 ? 'disabled' : '' }}>
...
@section('scripts')
    @vite(['resources/js/admin/keuangan/pembayaran/create.js'])
@endsection
