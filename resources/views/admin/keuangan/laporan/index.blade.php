...
<div class="container-fluid px-0">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.keuangan.laporan.index') }}" method="GET" class="row align-items-end">
                ...
                <div class="col-md-3 mb-2 text-end">
                    ...
                    <a href="{{ route('admin.keuangan.laporan.cetak', request()->query()) }}" target="_blank" class="btn btn-success btn-sm px-3 shadow-sm fw-bold">
