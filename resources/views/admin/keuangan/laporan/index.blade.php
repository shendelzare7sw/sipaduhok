...
@section('styles')
    @vite(['resources/css/admin/keuangan/laporan/index.css'])
@endsection
        ...
        <div class="p-4">
            <form action="{{ route('admin.keuangan.laporan.index') }}" method="GET" id="filterForm">
                ...
                <div class="d-flex gap-2 mt-3 flex-wrap align-items-center">
                    ...
                    <a href="{{ route('admin.keuangan.laporan.index') }}" class="btn btn-outline-secondary btn-sm px-3">
                        <i class="fas fa-undo me-1"></i> Reset
                    </a>
                    <a href="{{ route('admin.keuangan.laporan.cetak', request()->query()) }}" target="_blank" class="btn btn-outline-success btn-sm px-3 ms-auto d-flex align-items-center gap-1">
...
@section('scripts')
    @vite(['resources/js/admin/keuangan/laporan/index.js'])
@endsection
