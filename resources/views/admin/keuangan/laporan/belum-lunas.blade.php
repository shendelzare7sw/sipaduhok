...
<div class="late-shell">
    <div class="late-card">
        ...
        <form action="{{ route('admin.keuangan.laporan.belum-lunas') }}" method="GET" class="filter-wrapper">
            ...
            <a href="{{ route('admin.keuangan.laporan.cetak-belum-lunas', request()->query()) }}" class="btn btn-success btn-sm btn-soft px-3" target="_blank">
                <i class="fas fa-print"></i> Cetak Laporan
            </a>
            <a href="{{ route('admin.keuangan.laporan.belum-lunas') }}" class="btn btn-outline-danger btn-sm btn-soft px-3">
                            ...
                            <tr>
                                ...
                                <td class="mobile-card-actions" data-label="Aksi">
                                    <div class="action-btns">
                                        <a href="{{ route('admin.keuangan.tagihan.show', $siswa->id) }}" class="btn btn-sm btn-info text-white" title="Detail">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.keuangan.pembayaran.riwayat-siswa', $siswa->id) }}" class="btn btn-sm btn-success" title="Riwayat">
                                            <i class="fas fa-history"></i>
                                        </a>
                                        <a href="{{ route('admin.keuangan.pembayaran.create', $siswa->id) }}" class="btn btn-sm btn-warning text-dark" title="Input Bayar">
