                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        @if($s->validasi_ujian_bendahara)
                                            <span class="badge bg-success badge-status shadow-sm">✅ VALID</span>
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="btn-group gap-1">
                                            @if(!$s->validasi_ujian_bendahara)
                                                <button form="none" onclick="confirmAction('{{ route('admin.keuangan.validasi-akses.validasi-ujian', $s->id) }}', 'Validasi ujian {{ $s->nama_lengkap }}?')" class="btn btn-sm btn-success rounded-circle" title="Validasi Ujian"><i class="fas fa-check"></i></button>
                                            @else
                                                <button form="none" onclick="confirmAction('{{ route('admin.keuangan.validasi-akses.batalkan-ujian', $s->id) }}', 'Batalkan validasi ujian?')" class="btn btn-sm btn-outline-danger rounded-circle" title="Batal Ujian"><i class="fas fa-undo"></i></button>
                                            @endif

                                            @if(!$s->validasi_rapor_bendahara)
                                                <button form="none" onclick="confirmAction('{{ route('admin.keuangan.validasi-akses.validasi-rapor', $s->id) }}', 'Validasi rapor {{ $s->nama_lengkap }}?')" class="btn btn-sm btn-info rounded-circle" title="Validasi Rapor"><i class="fas fa-check"></i></button>
                                            @else
                                                <button form="none" onclick="confirmAction('{{ route('admin.keuangan.validasi-akses.batalkan-rapor', $s->id) }}', 'Batalkan validasi rapor?')" class="btn btn-sm btn-outline-danger rounded-circle" title="Batal Rapor"><i class="fas fa-undo"></i></button>
                                            @endif
