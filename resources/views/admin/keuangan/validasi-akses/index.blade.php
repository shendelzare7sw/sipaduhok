                            ...
                            <tr>
                                ...
                                <td class="mobile-card-actions" data-label="Aksi">
                                    <div class="action-btns">
                                        @if(!$s->validasi_ujian_bendahara)
                                            <button type="button" onclick="confirmAction('{{ route('admin.keuangan.validasi-akses.validasi-ujian', $s->id) }}', 'Validasi ujian {{ addslashes($s->nama_lengkap) }}?')" class="btn btn-sm btn-success" title="Validasi Ujian">
                                                <i class="fas fa-check"></i>
                                            </button>
                                        @else
                                            <button type="button" onclick="confirmAction('{{ route('admin.keuangan.validasi-akses.batalkan-ujian', $s->id) }}', 'Batalkan validasi ujian?')" class="btn btn-sm btn-outline-danger" title="Batal Ujian">
                                        ...
                                        @if(!$s->validasi_rapor_bendahara)
                                            @if($s->validasi_rapor_ketua)
                                                <button type="button" onclick="confirmAction('{{ route('admin.keuangan.validasi-akses.validasi-rapor', $s->id) }}', 'Validasi rapor {{ addslashes($s->nama_lengkap) }}?')" class="btn btn-sm btn-info text-white" title="Validasi Rapor">
                                                    <i class="fas fa-check"></i>
                                                </button>
                                            @else
                                            ...
                                            @endif
                                        @else
                                            <button type="button" onclick="confirmAction('{{ route('admin.keuangan.validasi-akses.batalkan-rapor', $s->id) }}', 'Batalkan validasi rapor?')" class="btn btn-sm btn-outline-danger" title="Batal Rapor">
                                                <i class="fas fa-undo"></i>
                                            </button>
                                        @endif
