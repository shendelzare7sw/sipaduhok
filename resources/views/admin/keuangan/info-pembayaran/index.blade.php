                                ...
                                <form action="{{ route('admin.keuangan.info-pembayaran.update') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="midtrans_merchant_id"
                                            ...
                                            placeholder="Contoh: G12345678" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="password" name="midtrans_server_key"
                                            class="form-control border-start border-success border-3 shadow-sm"
                                            placeholder="Mid-server-xxxxxxxx" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="midtrans_client_key"
                                            class="form-control border-start border-success border-3 shadow-sm"
                                            placeholder="Mid-client-xxxxxxxx" required>
                                    ...
                                    <div class="card mb-3 border-2" id="modeSelectionCard">
                                        <div class="card-body py-2">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" class="form-check-input" role="switch" id="is_production"
                                                    name="midtrans_is_production" value="1"
                                                    {{ old('midtrans_is_production', $infoPembayaran->midtrans_is_production ?? false) ? 'checked' : '' }}
                                                    onchange="updateModeDisplay()">
                                        ...
                                        <div class="accordion-item border-0">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed py-2 px-3 bg-light" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#guideCollapse">
