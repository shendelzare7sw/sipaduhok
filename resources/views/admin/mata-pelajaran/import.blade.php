...
@section('styles')
    @vite(['resources/css/admin/mata-pelajaran/import.css'])
@endsection
    ...
    <div class="mp-import-page">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.mata-pelajaran.import.store') }}" method="POST" enctype="multipart/form-data" id="importForm">
                    @csrf
...
@section('scripts')
    @vite(['resources/js/admin/mata-pelajaran/import.js'])
@endsection
