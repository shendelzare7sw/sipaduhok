    ...
    <div class="mp-card">
        <div class="mp-card-header">
            ...
            <div class="header-actions d-flex gap-2">
                <a href="{{ route('admin.mata-pelajaran.print', request()->only(['jenjang', 'search'])) }}" target="_blank" class="btn btn-secondary text-white btn-sm d-flex align-items-center gap-1">
                ...
                <a href="{{ route('admin.mata-pelajaran.create') }}" class="btn btn-primary btn-sm d-flex align-items-center gap-1">
        ...
        <form method="GET" class="mb-0 filter-form">
            <div class="filter-wrapper">
                ...
                <div class="filter-actions">
                    ...
                    @if($jenjang || $search !== '')
                        <a href="{{ route('admin.mata-pelajaran.index') }}" class="btn btn-outline-danger btn-sm filter-reset-btn">
                            ...
                            <tr>
                                ...
                                <td class="td-actions text-end">
                                    <div class="d-flex justify-content-end gap-1 action-btns">
                                        <a href="{{ route('admin.mata-pelajaran.show', $mapel) }}" class="btn btn-sm btn-info text-white" title="Detail">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.mata-pelajaran.edit', $mapel) }}" class="btn btn-sm btn-warning text-white" title="Edit">
        ...
        @else
            <div class="empty-state">
                ...
                <div class="empty-actions">
                    @if($jenjang || $search !== '')
                        <a href="{{ route('admin.mata-pelajaran.index') }}" class="btn btn-outline-secondary btn-sm px-3 rounded-pill">
                            <i class="fas fa-times me-1"></i> Reset Filter
                        </a>
                    @endif
                    <a href="{{ route('admin.mata-pelajaran.create') }}" class="btn btn-primary btn-sm px-3 rounded-pill">
