...
.info-banner h2 { font-size: 24px; font-weight: 700; margin-bottom: 8px; }
...
.info-banner-stats { display: flex; gap: 16px; }
...
.info-banner-stat-value { font-size: 24px; font-weight: 700; }
.info-banner-stat-label { font-size: 11px; opacity: 0.8; }
...
.siswa-info { display: flex; align-items: center; gap: 10px; }
...
.siswa-avatar.female { background: linear-gradient(135deg, #ec4899 0%, #db2777 100%); }
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if($availableSiswa->count() > 0 && $stats['sisaKuota'] > 0)
                    ...
                    <small style="color: #6b7280;">Menampilkan siswa tanpa kelas dari cabang {{ $kelas->cabang->nama_cabang ?? '' }}</small>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('admin.manajemen-siswa.remove-from-kelas', $kelas) }}" method="POST" id="deleteForm{{ $siswa->id }}">
                                        @csrf
                                        <input type="hidden" name="siswa_id" value="{{ $siswa->id }}">
                                        <button type="button" class="btn btn-danger btn-sm" title="Keluarkan" onclick="confirmRemoveSiswa('{{ $siswa->id }}', '{{ $siswa->nama_lengkap }}')">
