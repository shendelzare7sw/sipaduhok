        ...
        <div class="grid-2">
            ...
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            @foreach($siswa->orangTua as $parent)
                                <div class="info-item"
                                    ...
                                    <div style="display: flex; justify-content: space-between; align-items: start;">
                                        ...
                                        <form action="{{ route('admin.manajemen-siswa.detach-parent', [$siswa, $parent]) }}"
                    ...
                    @else
                        <div class="alert" style="background: #fef3c7; border: 1px solid #fde047; color: #92400e; margin: 0;">
                    ...
                    <div id="addParentFormContainer"
                        ...
                        @if($hasAyahKandung && $hasIbuKandung)
                            <div class="alert"
                                ...
                                Siswa ini sudah memiliki Ayah Kandung dan Ibu Kandung. Anda masih dapat menambahkan wali/orang
                            ...
                            <form action="{{ route('admin.manajemen-siswa.attach-parent', $siswa) }}" method="POST"
                                ...
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
                                    <div class="form-group" style="margin-bottom: 0;">
                                        <label class="form-label"><i class="fas fa-search" style="color: #9ca3af;"></i> Cari
                                            Orang Tua</label>
                                    ...
                                    <div class="form-group" style="margin-bottom: 0;">
                                        <label class="form-label"><i class="fas fa-filter" style="color: #9ca3af;"></i>
                                            Filter Status</label>
                                        <select id="filterParentStatus" class="form-control" onchange="filterParentList()">
                                ...
                                {{-- Parent List --}}
                                <div class="form-group">
                                    <label class="form-label">Pilih Orang Tua <span style="color: #ef4444;">*</span> <small
                                            style="color: #6b7280; font-weight: normal;">(<span
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="relationship" id="relationshipSelect" class="form-control" required
                                        ...
                                        <option value="ayah_kandung" {{ $hasAyahKandung ? 'disabled' : '' }}>Ayah Kandung
            ...
            <div class="modal-content" style="border: none; border-radius: 16px; overflow: hidden;">
                ...
                <div class="modal-body" style="padding: 24px;">
                    ...
                    <div
                        ...
                        <div style="font-size: 14px; color: #6b7280;">Hubungan: <span id="detachParentRelationship"></span>
                        </div>
                    </div>
                    <p style="color: #6b7280; font-size: 14px; margin: 0;">
                        <i class="fas fa-info-circle"></i> Hubungan akan dihapus. Orang tua masih bisa dihubungkan kembali
                        nanti.
                    </p>
                </div>
