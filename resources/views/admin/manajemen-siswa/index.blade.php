    ...
    <div class="card">
        <div class="card-header">
            ...
            <div style="display: flex; gap: 10px;">
                <a href="{{ route('admin.manajemen-siswa.print', request()->query()) }}" class="btn btn-print" target="_blank">
        ...
        <div class="card-body">
            {{-- Filter Section --}}
            <form action="{{ route('admin.manajemen-siswa.index') }}" method="GET">
                            ...
                            <tr>
                                ...
                                <td class="mobile-card-actions">
                                    <div class="action-buttons">
                                        ...
                                        <a href="{{ route('admin.manajemen-siswa.print-kartu', $siswa) }}" class="btn btn-icon btn-light-success" title="Cetak Kartu" target="_blank">
