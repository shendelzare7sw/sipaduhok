...
<div class="container-fluid px-0">
    ...
    <div class="card shadow mb-4">
        <div class="card-body py-3 d-flex flex-row align-items-center justify-content-between bg-white">
            ...
            <a href="{{ route('sekretaris.flyer.create') }}" class="btn btn-primary btn-sm shadow-sm fw-bold">
            ...
            <div class="card flyer-card shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="row no-gutters gap-2">
                        <div class="col pe-1">
                            <a href="{{ route('sekretaris.flyer.edit', $item->id) }}" class="btn btn-warning btn-sm w-100 fw-bold">
