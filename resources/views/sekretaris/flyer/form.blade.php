...
@section('styles')
    @vite(['resources/css/sekretaris/flyer/form.css'])
@endsection

@section('content')
<div class="sekretaris-flyer-form-page">
<div class="row">
    <div class="col-lg-8">
        <div class="content-card">
            <form action="{{ isset($flyer) ? route('sekretaris.flyer.update', $flyer->id) : route('sekretaris.flyer.store') }}" 
                  method="POST" 
...
@section('scripts')
    @vite(['resources/js/sekretaris/flyer/form.js'])
@endsection
