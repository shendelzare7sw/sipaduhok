...
@section('styles')
    @vite(['resources/css/sekretaris/pengumuman/form.css'])
@endsection

@section('content')
<div class="sekretaris-announcement-form-page">
<div class="row">
    <div class="col-lg-8">
        <div class="content-card">
            <form action="{{ isset($pengumuman) ? route('sekretaris.pengumuman.update', $pengumuman->id) : route('sekretaris.pengumuman.store') }}" 
                  method="POST" 
                ...
                @if(isset($pengumuman))
                    @method('PUT')
                @endif
                <input type="hidden" name="_return_url" value="{{ url()->previous(route('sekretaris.pengumuman.index')) }}">
                ...
                <div class="d-flex justify-content-between announcement-form-actions">
                    <a href="{{ url()->previous(route('sekretaris.pengumuman.index')) }}" class="btn btn-secondary">
