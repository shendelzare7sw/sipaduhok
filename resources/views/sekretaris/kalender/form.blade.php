        ...
        <div class="content-card">
            <form action="{{ isset($kalender) ? route('sekretaris.kalender.update', $kalender->id) : route('sekretaris.kalender.store') }}" 
                ...
                @if(isset($kalender))
                    @method('PUT')
                @endif
                <input type="hidden" name="_return_url" value="{{ url()->previous(route('sekretaris.kalender.index')) }}">
                ...
                <div class="d-flex justify-content-between calendar-form-actions">
                    <a href="{{ url()->previous(route('sekretaris.kalender.index')) }}" class="btn btn-secondary">
