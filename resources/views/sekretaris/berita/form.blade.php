...
@section('styles')
    @vite(['resources/css/sekretaris/berita/form.css'])
@endsection

@section('content')
<div class="sekretaris-news-form-page">
<div class="sekretaris-news-form-inner">
    <div class="row-custom">
        ...
        <div class="col-main">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ isset($berita) ? route('sekretaris.berita.update', $berita->id) : route('sekretaris.berita.store') }}" 
                          method="POST" 
                        ...
                        @if(isset($berita))
                            @method('PUT')
                        @endif
                        <input type="hidden" name="_return_url" value="{{ url()->previous(route('sekretaris.berita.index')) }}">
                        ...
                        <div class="form-footer-actions">
                            <a href="{{ url()->previous(route('sekretaris.berita.index')) }}" class="btn btn-secondary">Batal</a>
...
@section('scripts')
    @vite(['resources/js/sekretaris/berita/form.js'])
@endsection
