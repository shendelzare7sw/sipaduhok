...
@section('content')
    <div style="max-width: 1400px; margin: 0 auto; padding: 0 1rem;">
        <div style="max-width: 1400px;">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('sekretaris.berita.create') }}" class="btn btn-primary">
                        <i class="fas fa-plus me-2"></i> Tambah Berita
                    </a>
                </div>

                <div class="card-body">
                    <form method="GET" action="{{ route('sekretaris.berita.index') }}">
                        <div class="filter-section">
                            ...
                            @if(request()->hasAny(['search', 'kategori', 'status']) && request('kategori') != 'all')
                                <a href="{{ route('sekretaris.berita.index') }}" class="btn btn-outline">
                    ...
                    @if($berita->count() > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-buttons">
                                                    ...
                                                    <button type="button" onclick="openModal('featuredModal{{ $item->id }}')"
                                                    ...
                                                    <a href="{{ route('sekretaris.berita.edit', $item->id) }}"
                                                        class="btn btn-icon btn-light-primary" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>

                                                    <button type="button" class="btn btn-icon btn-light-danger" title="Hapus"
                        ...
                        @if($berita->hasPages())
                            <div class="pagination-wrapper">
                                <div class="pagination-info">Menampilkan {{ $berita->firstItem() }} - {{ $berita->lastItem() }} dari
                                    {{ $berita->total() }} data</div>
                    ...
                    @else
                        <div class="empty-state">
                            ...
                            <a href="{{ route('sekretaris.berita.create') }}" class="btn btn-primary"><i
        ...
        {{-- Featured Modal Loop --}}
        @foreach($berita as $item)
            <div class="modal fade" id="featuredModal{{ $item->id }}" tabindex="-1"
                aria-labelledby="featuredModalLabel{{ $item->id }}" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow-lg">
