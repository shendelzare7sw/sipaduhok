        ...
        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="{{ route('sekretaris.berita.edit', $item->id) }}" class="btn btn-icon btn-light-primary" title="Edit">
            ...
            @else
                <div class="empty-state">
                    ...
                    <a href="{{ route('sekretaris.berita.create') }}" class="btn btn-primary"><i class="fas fa-plus me-2"></i> Tambah Berita</a>
                </div>
            @endif
        </div>
    </div>
