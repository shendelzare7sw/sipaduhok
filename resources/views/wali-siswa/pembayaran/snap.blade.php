...
@section('styles')
    @vite(['resources/css/wali-siswa/pembayaran/snap.css'])
@endsection

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y parent-snap-page"
        data-snap-token="{{ $snapToken }}"
        data-finish-url="{{ route('wali-siswa.pembayaran.snap.finish') }}"
            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-body text-center py-5">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('wali-siswa.tagihan.anak', $pembayaran->siswa_id) }}"
...
@section('scripts')
    @vite(['resources/js/wali-siswa/pembayaran/snap.js'])
@endsection
