...
@section('content')
<div class="container-xxl flex-grow-1 container-p-y wali-siswa-ajukan-izin-page">
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('wali-siswa.presensi.store-izin', $siswa->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
