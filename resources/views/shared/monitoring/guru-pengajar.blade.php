@php
    $routeBase = $routeBase ?? 'ketua.monitoring';
    $scopeLabel = $scopeLabel ?? 'Semua cabang';
...
<div class="container-xxl flex-grow-1 container-p-y monitoring-page">
    <div class="page-panel">
        <div>
            <span class="panel-kicker">Monitoring LMS</span>
            <h4 class="panel-title">Guru Pengajar</h4>
            <p class="panel-subtitle mb-0">Pantau penugasan kelas, konten LMS, koreksi tugas, dan progress nilai guru.</p>
        </div>
                                                ...
                                                <div class="mobile-detail-section">
                                                    ...
                                                    <div class="progress-wrap">
                                                        <div class="progress-track">
                                                            <div class="progress-fill {{ $progressClass }}" style="width: {{ min($progress, 100) }}%"></div>
                                                        </div>
