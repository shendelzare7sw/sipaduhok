            ...
            <div class="card-body">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <a href="{{ route('waka.kelas.edit', $kelas) }}" class="btn btn-success" style="margin-top: 16px;">
        ...
        <div class="card-body">
            ...
            @else
                <div class="empty-state">
                    ...
                    <a href="{{ route('waka.kelas.manage-siswa', $kelas) }}" class="btn btn-success" style="margin-top: 16px;">
