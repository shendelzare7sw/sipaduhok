            ...
            <div class="card">
                <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <button type="button" class="btn btn-sm btn-primary"
                        onclick="document.getElementById('addParentForm').style.display = 'block';">
                ...
                <div class="card-body">
                    ...
                    <div id="addParentForm"
                        style="display: none; margin-top: 20px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
                        <div
                            style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                            <h6 style="margin: 0;">Tambah Orang Tua / Wali</h6>
                            <button type="button" class="btn btn-sm btn-white-outline" style="border: none; color: #6b7280;"
                                onclick="document.getElementById('addParentForm').style.display = 'none';">
                        ...
                        <form action="{{ route('waka.manajemen-siswa.attach-parent', $siswa) }}" method="POST">
                            ...
                            <div style="display: flex; gap: 8px;">
                                ...
                                <button type="button" class="btn btn-white-outline" style="flex: 1;"
                                    onclick="document.getElementById('addParentForm').style.display = 'none';">
