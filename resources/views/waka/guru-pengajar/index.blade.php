    ...
    <div class="stat-row">
        <div class="stat-widget">
            ...
            <div class="stat-details">
                ...
                <div class="stat-desc">Guru aktif di cabang</div>
            </div>
        </div>
    ...
    <div class="gp-card">
        <div class="gp-card-header">
            ...
            <div class="header-actions d-flex gap-2">
                <a href="{{ route('waka.guru-pengajar.print', request()->query()) }}" class="btn btn-secondary text-white d-flex align-items-center gap-1" target="_blank">
        ...
        <!-- Filters -->
        <form action="{{ route('waka.guru-pengajar.index') }}" method="GET" class="mb-0">
                            ...
                            <td class="td-actions text-end" data-label="Aksi">
                                <div class="d-flex justify-content-end gap-1 action-btns">
                                    <a href="{{ route('waka.guru-pengajar.show', ['guruPengajar' => $guru, 'tahun_ajaran_id' => request('tahun_ajaran_id')]) }}"
                                       class="btn btn-sm btn-info text-white px-2 py-1 rounded" title="Lihat Penugasan">
        ...
        @else
            <div class="empty-state">
                ...
                Pastikan jadwal pelajaran sudah dibuat dan guru sudah ditugaskan di cabang Anda.</p>
