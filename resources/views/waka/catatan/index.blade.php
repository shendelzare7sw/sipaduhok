...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="card mb-3 border-start border-{{ $item->prioritas == 'mendesak' ? 'danger' : ($item->prioritas == 'penting' ? 'warning' : 'primary') }} border-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <h5 class="card-title mb-1">{{ $item->judul }}</h5>
                        <span class="badge bg-{{ $item->prioritas == 'mendesak' ? 'danger' : ($item->prioritas == 'penting' ? 'warning' : 'info') }}">
                    ...
                    <div class="d-flex gap-3 text-muted small">
                        ...
                        <span>
                            <i class="fas fa-{{ $item->tipe_penerima == 'semua' ? 'users' : ($item->tipe_penerima == 'role' ? 'user-tag' : 'user') }} me-1"></i>
                    ...
                    <div class="mt-2">
                        <a href="{{ route('waka.catatan.show', $item->id) }}" class="btn btn-sm btn-outline-primary">
