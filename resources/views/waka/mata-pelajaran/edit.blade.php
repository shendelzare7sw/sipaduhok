    ...
    <div class="col-xl-8">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                ...
                <a href="{{ url()->previous(route('waka.mata-pelajaran.index')) }}" class="btn btn-sm btn-secondary">
                    <i class="fas fa-arrow-left me-1"></i> Kembali
                </a>
            </div>
            <div class="card-body">
                <form action="{{ route('waka.mata-pelajaran.update', $mataPelajaran) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="_return_url" value="{{ url()->previous(route('waka.mata-pelajaran.index')) }}">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ url()->previous(route('waka.mata-pelajaran.index')) }}" class="btn btn-secondary">
