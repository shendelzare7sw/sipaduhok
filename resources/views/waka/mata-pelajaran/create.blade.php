            ...
            <div class="card-body">
                <form action="{{ route('waka.mata-pelajaran.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="filter_agama" id="filter_agama" class="form-select @error('filter_agama') is-invalid @enderror">
                            ...
                            @foreach($agamaList as $agama)
                                <option value="{{ $agama }}" {{ old('filter_agama') == $agama ? 'selected' : '' }}>
                                    {{ $agama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="suggestionsContainer" class="mt-2 d-none" data-suggest-url="{{ route('waka.mata-pelajaran.suggest-kode') }}">
...
@section('scripts')
    @vite(['resources/js/waka/mata-pelajaran/form.js'])
@endsection
