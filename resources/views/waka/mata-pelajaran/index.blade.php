        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('waka.mata-pelajaran.import') }}" class="btn btn-success">
                        ...
                        <tbody>
                            @foreach($mataPelajaranList as $index => $mapel)
                                <tr>
                                    ...
                                    <td>
                                        <small
                                            class="text-muted">{{ $mapel->deskripsi ? Str::limit($mapel->deskripsi, 50) : '-' }}</small>
                                    </td>
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="{{ route('waka.mata-pelajaran.edit', $mapel) }}" class="btn btn-sm btn-warning"
                                                title="Edit">
