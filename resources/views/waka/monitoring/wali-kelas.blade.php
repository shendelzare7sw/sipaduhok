{{-- resources/views/waka/monitoring/wali-kelas.blade.php --}}
    ...
    <div style="max-width: 1400px; margin: 0 auto; padding: 0 1rem;">
        <div class="card">
            <div class="card-header"
                ...
                <form action="{{ route('waka.monitoring.wali-kelas') }}" method="GET" class="filter-group" style="display: flex; gap: 12px; align-items: center;">
                    <!-- Search -->
