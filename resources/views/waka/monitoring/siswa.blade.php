                        ...
                        <tbody>
                            @foreach($siswa as $s)
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <div class="progress-mini">
                                            <div class="progress-mini-fill 
                                                ...
                                                @else progress-low
                                                @endif" style="width: {{ $s->progress_tugas }}%">
                                            </div>
                                        </div>
                                    ...
                                    <td style="text-align: right;">
                                        <strong style="color: #10b981;">Rp
                                            {{ number_format($s->total_bayar, 0, ',', '.') }}</strong>
                                    </td>
                                    <td style="text-align: center;">
                                        ...
                                        @else
                                            <span class="status-box status-belum-lunas">
                                                <i class="fas fa-exclamation-triangle"></i> Sisa: Rp
                                                {{ number_format($s->sisa_tagihan, 0, ',', '.') }}
                                            </span>
                                        @endif
                                    </td>
                                </tr>
