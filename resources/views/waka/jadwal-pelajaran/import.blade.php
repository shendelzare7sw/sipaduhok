        ...
        <div class="card jp-import-card">
            ...
            <div class="card-body">
                <div class="jp-template-actions">
                    <a href="{{ route('waka.jadwal-pelajaran.template') }}" class="btn btn-success">
                        <i class="fas fa-download"></i> Download Template
                    </a>
                </div>

                <form action="{{ route('waka.jadwal-pelajaran.import.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="jp-actions">
                        <a href="{{ route('waka.jadwal-pelajaran.index') }}" class="btn btn-secondary">
...
@section('scripts')
    @vite(['resources/js/waka/jadwal-pelajaran/import.js'])
@endsection
