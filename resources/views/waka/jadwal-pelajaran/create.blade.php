...
{{-- Error Messages --}}
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('waka.jadwal-pelajaran.store') }}" method="POST" id="jadwalForm">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="tahun_ajaran_id" id="tahunAjaranSelect" class="form-select" required
                                        data-create-url="{{ route('waka.jadwal-pelajaran.create') }}">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 small">Silakan konfigurasi waktu istirahat terlebih dahulu di menu <a
                                            href="{{ route('waka.pengaturan-istirahat.index') }}" class="alert-link">Pengaturan
                                            Istirahat</a></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <a href="{{ route('waka.jadwal-pelajaran.index', request()->query()) }}" class="btn btn-secondary">
...
@section('scripts')
    ...
    <div id="jadwalFormConfig"
        ...
        data-current-mapel-id=""
        data-current-mapel-jenjang=""></div>
{{-- Modal Pilih Guru --}}
                            ...
                            @foreach($guruList as $g)
                                <div class="guru-option-item" data-id="{{ $g->id }}"
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="guru-role">{{ $g->user->cabang->nama_cabang ?? '-' }}
                                        </div>
                                    </div>
                                </div>
                            @endforeach
