...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a href="{{ route('waka.jadwal-pelajaran.export-pdf', request()->query()) }}" class="btn btn-danger btn-sm" target="_blank">
                <i class="fas fa-file-pdf me-1"></i> Export PDF
            </a>
            <a href="{{ route('waka.jadwal-pelajaran.export-excel', request()->query()) }}" class="btn btn-success btn-sm">
