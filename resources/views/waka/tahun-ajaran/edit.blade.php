        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ url()->previous(route('waka.tahun-ajaran.index')) }}" class="btn btn-secondary btn-sm">
                ...
                <form action="{{ route('waka.tahun-ajaran.update', $tahunAjaran->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="_return_url" value="{{ url()->previous(route('waka.tahun-ajaran.index')) }}">
                    ...
                    <div class="card-footer d-flex justify-content-end gap-2">
                        <a href="{{ url()->previous(route('waka.tahun-ajaran.index')) }}" class="btn btn-secondary">
                            Batal
                        </a>
