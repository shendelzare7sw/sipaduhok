...
@section('styles')
    @vite(['resources/css/waka/tahun-ajaran/index.css'])
@endsection
...
<div class="tahun-ajaran-index-page">
    ...
    <div class="alert alert-primary d-flex justify-content-between align-items-center mb-4 border-0 shadow-sm filter-alert">
        ...
        <a href="{{ route('waka.tahun-ajaran.index') }}" class="btn btn-sm btn-light text-primary fw-bold btn-reset-filter">
    ...
    <div class="ta-card">
        <div class="ta-card-header">
            ...
            <div class="filter-wrapper">
                ...
                <a href="{{ route('waka.tahun-ajaran.create') }}" class="btn btn-primary d-flex align-items-center gap-2 btn-create-ta">
                        ...
                        <td class="td-actions text-end" data-label="Aksi">
                            <div class="d-flex justify-content-end gap-1 action-btns">
                                ...
                                <button type="button"
                                        ...
                                        data-delete-ta
                                        data-delete-url="{{ route('waka.tahun-ajaran.destroy', $ta->id) }}"
...
@section('scripts')
    @vite(['resources/js/waka/tahun-ajaran/index.js'])
@endsection
