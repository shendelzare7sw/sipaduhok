            ...
            <div class="legal-card bg-white rounded-2xl shadow-lg p-5 md:p-8 lg:p-10 mb-8 border-2 border-green-100">
                <div class="flex flex-col md:flex-row items-start mb-6">
                    ...
                    <div class="flex-1 min-w-0 w-full">
                        <h2 class="text-xl md:text-2xl font-bold text-gray-800 mb-4">11. Hubungi Kami</h2>
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 sm:p-6 space-y-4">
                            <p class="text-sm md:text-base text-gray-700"><strong>PKBM House Of Knowledge</strong></p>
                            <div class="text-sm md:text-base text-gray-600 flex items-start">
                                <svg class="w-5 h-5 text-gray-400 mr-3 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                                <span class="break-words">Jl. Ruko Reni Jaya No.22, RW.23, Pamulang Bar., Kec. Pamulang, Kota Tangerang Selatan</span>
                            </div>
                            <div class="text-sm md:text-base text-gray-600 flex items-start">
                                <svg class="w-5 h-5 text-gray-400 mr-3 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                                <span class="break-all sm:break-normal">hokhomeschool@gmail.com</span>
                            </div>
                            <div class="text-sm md:text-base text-gray-600 flex items-start">
