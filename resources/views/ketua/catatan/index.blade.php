...
@section('styles')
    @vite('resources/css/ketua/catatan/index.css')
@endsection
                                ...
                                <div class="catatan-actions">
                                    ...
                                    @if(!$showDirection || $isSentByCurrentUser)
                                        <button type="button"
                                            ...
                                            data-catatan-delete
                                            data-catatan-id="{{ $item->id }}"
                                            data-catatan-title="{{ $item->judul }}">
...
<div class="modal fade" id="deleteCatatanModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered catatan-delete-dialog">
...
<form id="deleteCatatanForm" method="POST" class="catatan-hidden-form">
    @csrf
    @method('DELETE')
</form>
@endsection
...
@section('scripts')
    <template id="catatanDeleteConfig" data-base-path="/ketua/catatan"></template>
    @vite('resources/js/ketua/catatan/index.js')
@endsection
