...
@section('styles')
    @vite(['resources/css/ketua/laporan/index.css'])
@endsection
    ...
    <div class="report-grid">
        ...
        <div class="rpt-card">
            ...
            <div class="rpt-card-body">
                <form action="{{ route('ketua.laporan.siswa') }}" method="GET" target="_blank" class="rpt-form" id="formSiswa">
        ...
        <div class="rpt-card">
            ...
            <div class="rpt-card-body">
                <form action="{{ route('ketua.laporan.tenaga-pendidik') }}" method="GET" target="_blank" class="rpt-form">
                    <div class="rpt-form-group">
                        <label>Role</label>
                        <select name="role">
        ...
        <div class="rpt-card">
            ...
            <div class="rpt-card-body">
                <form action="{{ route('ketua.laporan.kelas') }}" method="GET" target="_blank" class="rpt-form">
                    <div class="rpt-form-group">
                        <label>Tahun Ajaran</label>
                        <select name="tahun_ajaran_id">
                            @foreach($tahunAjarans as $ta)
        ...
        <div class="rpt-card">
            ...
            <div class="rpt-card-body">
                <form action="{{ route('ketua.laporan.wali-kelas') }}" method="GET" target="_blank" class="rpt-form">
                    <div class="rpt-form-group">
                        <label>Tahun Ajaran</label>
                        <select name="tahun_ajaran_id">
                            @foreach($tahunAjarans as $ta)
        ...
        <div class="rpt-card">
            ...
            <div class="rpt-card-body">
                <form action="{{ route('ketua.laporan.guru-pengajar') }}" method="GET" target="_blank" class="rpt-form">
                    <div class="rpt-form-group">
                        <label>Tahun Ajaran</label>
                        <select name="tahun_ajaran_id">
                            @foreach($tahunAjarans as $ta)
        ...
        <div class="rpt-card">
            ...
            <div class="rpt-card-body">
                <form action="{{ route('ketua.laporan.rekap') }}" method="GET" target="_blank" class="rpt-form">
                    <div class="rpt-form-group">
                        <label>Tahun Ajaran</label>
                        <select name="tahun_ajaran_id">
                            @foreach($tahunAjarans as $ta)
        ...
        <div class="rpt-card">
            <div class="rpt-card-header">
                <div class="rpt-card-icon bg-rpt-academic">
                    <i class="fas fa-user-graduate"></i>
                </div>
                <div class="rpt-card-info">
            ...
            <div class="rpt-card-body">
                <form action="{{ route('ketua.laporan.rekap-akademik') }}" method="GET" target="_blank" class="rpt-form">
                    ...
                    <button type="submit" class="btn-rpt-print btn-rpt-academic">
...
@section('scripts')
    @vite(['resources/js/ketua/laporan/index.js'])
@endsection
