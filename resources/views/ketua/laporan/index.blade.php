    ...
    <div class="report-grid">
        ...
        <div class="report-card">
            ...
            <div class="report-card-body">
                ...
                <form action="{{ route('ketua.laporan.siswa') }}" method="GET" target="_blank" class="report-form" id="formSiswa">
        ...
        <div class="report-card">
            ...
            <div class="report-card-body">
                ...
                <form action="{{ route('ketua.laporan.tenaga-pendidik') }}" method="GET" target="_blank" class="report-form">
                    <div class="form-group">
                        <label>Role</label>
                        <select name="role">
        ...
        <div class="report-card">
            ...
            <div class="report-card-body">
                ...
                <form action="{{ route('ketua.laporan.kelas') }}" method="GET" target="_blank" class="report-form">
                    <div class="form-group">
        ...
        <div class="report-card">
            ...
            <div class="report-card-body">
                ...
                <form action="{{ route('ketua.laporan.wali-kelas') }}" method="GET" target="_blank" class="report-form">
                    <div class="form-group">
                        <label>Tahun Ajaran</label>
                        <select name="tahun_ajaran_id">
                            @foreach($tahunAjarans as $ta)
        ...
        <div class="report-card">
            ...
            <div class="report-card-body">
                ...
                <form action="{{ route('ketua.laporan.guru-pengajar') }}" method="GET" target="_blank" class="report-form">
                    <div class="form-group">
                        <label>Tahun Ajaran</label>
                        <select name="tahun_ajaran_id">
                            @foreach($tahunAjarans as $ta)
        ...
        <div class="report-card">
            ...
            <div class="report-card-body">
                ...
                <form action="{{ route('ketua.laporan.rekap') }}" method="GET" target="_blank" class="report-form">
                    <div class="form-group">
                        <label>Tahun Ajaran</label>
                        <select name="tahun_ajaran_id">
                            @foreach($tahunAjarans as $ta)
...
document.addEventListener('DOMContentLoaded', function() {
    // Kelas data for cascading filter
    @php
    ...
    // When Cabang changes → show Jenjang, filter unique jenjangs for that cabang
    cabangSelect.addEventListener('change', function() {
        ...
        if (cabangId) {
            // Get unique jenjangs for this cabang
    ...
    // When Jenjang changes → show Kelas, filter by cabang + jenjang
