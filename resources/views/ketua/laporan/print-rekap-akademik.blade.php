...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-box { border: 1.5px solid #cbd5e1; border-radius: 6px; padding: 10px 8px; text-align: center; }
        ...
        .section h4 { font-size: 11pt; font-weight: 700; background: #f1f5f9; padding: 6px 10px; border-left: 4px solid #4361ee; margin-bottom: 6px; }
        ...
        thead th { background: #e2e8f0; padding: 6px 8px; text-align: left; font-weight: 700; font-size: 9pt; border: 1px solid #cbd5e1; }
...
<body>
    <div class="btn-actions no-print">
        <a href="{{ route('ketua.laporan.index') }}" class="btn-back"><i class="bi bi-arrow-left"></i> Kembali</a>
