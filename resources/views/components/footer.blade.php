@php
    ...
    $about = array_merge($about, [
        ...
        'description' => 'Layanan homeschooling perorangan dengan akses LMS dan pembayaran tagihan orang tua dalam satu portal.',
    ]);
...
<footer class="bg-gradient-to-br from-gray-900 to-gray-800 text-white pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
                <div class="mb-6">
                    <img src="{{ asset($about['logo'] ?? 'img/logo.png') }}" alt="Logo HOK Homeschooling" class="h-16 mb-4">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="{{ $about['facebook_url'] }}" class="text-gray-300 hover:text-blue-400 transition duration-300">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    @endif
                    @if(!empty($about['youtube_url']))
                    <a href="{{ $about['youtube_url'] }}" class="text-gray-300 hover:text-blue-400 transition duration-300">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    </a>
                    @endif
                    @if(!empty($about['tiktok_url']))
                    <a href="{{ $about['tiktok_url'] }}" class="text-gray-300 hover:text-blue-400 transition duration-300">
                    ...
                    <a href="{{ $about['instagram_url'] }}" class="text-gray-300 hover:text-blue-400 transition duration-300">
        ...
        <div class="border-t border-gray-700 pt-8 mt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm text-center md:text-left mb-4 md:mb-0">
                    &copy; {{ date('Y') }} HOK Homeschooling. All rights reserved.
                </p>
