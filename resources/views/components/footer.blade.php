...
<footer class="bg-gradient-to-br from-gray-900 to-gray-800 text-white pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
                <div class="mb-6">
                    <img src="{{ asset($about['logo'] ?? 'img/logo.png') }}" alt="Logo Sekolah" class="h-16 mb-4">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-300 text-sm">
                            {{ $contact['address'] ?? 'Jl. Ruko Reni Jaya No.22, RW.23, Pamulang Bar., Kec. Pamulang, Kota Tangerang Selatan' }}
                        </span>
                    </li>
