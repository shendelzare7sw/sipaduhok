...
<body>
    ...
    <script>
        (function () {
            ...
            window.fixLmsStudentNotifDropdownPosition = function (force) {
            ...
            window.fixNotifDropdownPosition = window.fixLmsStudentNotifDropdownPosition;

            function initLmsStudentNotifDropdown() {
                const btn = notifButton();
                const menu = notifMenu();
                if (!btn || !menu) return;
                ...
                btn.addEventListener('show.bs.dropdown', function () {
                    clearMobileLock(menu);
                    window.fixLmsStudentNotifDropdownPosition(true);
                    lockPageScroll();

                    requestAnimationFrame(function () {
                        window.fixLmsStudentNotifDropdownPosition(false);
                    });
                });
            ...
            if (document.readyState === 'loading') {
                document.addEventListener('DOMContentLoaded', initLmsStudentNotifDropdown);
            } else {
                initLmsStudentNotifDropdown();
            }
        })();
    </script>
