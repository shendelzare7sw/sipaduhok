                ...
                <div class="card-body text-center py-5">
                    ...
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <strong>{{ $pembayaran->tagihan->jenis_tagihan }} - {{ $pembayaran->tagihan->nama_tagihan }}</strong>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <strong class="text-primary fs-5">Rp {{ number_format($pembayaran->jumlah_bayar, 0, ',', '.') }}</strong>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info border-0 shadow-sm">
                        ...
                        <small>
                            Tersedia berbagai metode pembayaran: Virtual Account, E-Wallet (GoPay, ShopeePay), QRIS, dan Kartu Kredit
                        </small>
                    </div>
                    ...
                    <div class="mt-3">
                        <a href="{{ route('orang-tua.tagihan.anak', $pembayaran->siswa_id) }}" class="btn btn-link text-muted">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer border-0 justify-content-center">
                    ...
                    <a href="{{ route('orang-tua.tagihan.anak', $pembayaran->siswa_id) }}" class="btn btn-outline-secondary">
                        <i class="fas fa-arrow-left me-1"></i>
                        Kembali ke Tagihan
                    </a>
                </div>
...
@section('scripts')
<script src="https://app.{{ \App\Models\InfoPembayaran::getInstance()->midtrans_is_production ? '' : 'sandbox.' }}midtrans.com/snap/snap.js" data-client-key="{{ $clientKey }}"></script>
