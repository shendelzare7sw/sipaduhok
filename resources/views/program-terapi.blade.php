...
<body class="bg-gray-50">
    ...
    <section class="relative h-[400px] flex items-center justify-center" style="background-image: url('{{ asset('img/hero-bg.jpg') }}'); background-size: cover; background-position: center;">
        ...
        <div class="relative z-10 text-center text-white px-4">
            <nav class="text-sm mb-4">
                ...
                <span>Program</span>
                <span class="mx-2">/</span>
                <span class="font-semibold">Program Terapi</span>
            </nav>
            <h1 class="text-4xl md:text-5xl font-bold">Program Terapi</h1>
            <p class="mt-4 text-lg text-white/90">Layanan Terapi Profesional untuk Tumbuh Kembang Anak</p>
        </div>
    </section>
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <span class="inline-block bg-[#287f3b]/20 text-[#287f3b] px-4 py-2 rounded-full text-sm font-semibold mb-4">Program Terapi</span>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Layanan Terapi Profesional</h2>
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Program Terapi kami menyediakan berbagai layanan terapi untuk mendukung tumbuh kembang anak. Setiap sesi terapi dilakukan oleh tenaga profesional yang berpengalaman dan tersertifikasi.
                    </p>
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Kami menyediakan ruang terapi yang nyaman dan dilengkapi dengan peralatan modern untuk memaksimalkan hasil terapi.
                    </p>
                    <div class="flex items-center gap-4">
                        <div class="text-center">
                            <p class="text-3xl font-bold text-[#287f3b]">5+</p>
                            <p class="text-gray-600 text-sm">Jenis Terapi</p>
                        </div>
                        <div class="w-px h-12 bg-gray-300"></div>
                        <div class="text-center">
                            <p class="text-3xl font-bold text-[#165fac]">10+</p>
                            <p class="text-gray-600 text-sm">Terapis Ahli</p>
                        </div>
                        <div class="w-px h-12 bg-gray-300"></div>
                        <div class="text-center">
                            <p class="text-3xl font-bold text-[#d45930]">500+</p>
                            <p class="text-gray-600 text-sm">Klien Terbantu</p>
                        </div>
                    </div>
                </div>
                <div class="relative">
                    <img src="{{ asset('img/terapi-img.jpg') }}" alt="Program Terapi" class="rounded-2xl shadow-xl w-full">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Jenis Layanan Terapi</h2>
                <p class="text-gray-600 max-w-2xl mx-auto">Berbagai layanan terapi profesional untuk kebutuhan anak</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="card-hover bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4">Membantu anak mengembangkan kemampuan berbicara, bahasa, dan komunikasi secara efektif.</p>
                        <ul class="text-sm text-gray-600 space-y-2">
                            <li class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-[#287f3b]" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                ...
                <div class="card-hover bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4">Mengembangkan keterampilan motorik halus dan kemandirian dalam aktivitas sehari-hari.</p>
                        <ul class="text-sm text-gray-600 space-y-2">
                            <li class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-[#287f3b]" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                Motorik halus
                ...
                <div class="card-hover bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4">Membantu anak memproses dan merespons informasi sensorik dengan lebih baik.</p>
                        <ul class="text-sm text-gray-600 space-y-2">
                            <li class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-[#287f3b]" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                Pengolahan sensorik
                ...
                <div class="card-hover bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4">Applied Behavior Analysis untuk mengembangkan perilaku positif dan mengurangi perilaku yang tidak diinginkan.</p>
                        <ul class="text-sm text-gray-600 space-y-2">
                            <li class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-[#287f3b]" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                Modifikasi perilaku
                ...
                <div class="card-hover bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4">Meningkatkan kemampuan motorik kasar, keseimbangan, dan kekuatan otot anak.</p>
                        <ul class="text-sm text-gray-600 space-y-2">
                            <li class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-[#287f3b]" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                Motorik kasar
                ...
                <div class="card-hover bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm mb-4">Layanan konseling untuk membantu anak mengatasi masalah emosional dan psikologis.</p>
                        <ul class="text-sm text-gray-600 space-y-2">
                            <li class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-[#287f3b]" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                Asesmen psikologi
    ...
    <section class="py-20 bg-[#165fac]">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-white/80 mb-8 text-lg">Tim terapis profesional kami siap membantu tumbuh kembang anak Anda</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ url('/kontak') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white text-[#165fac] font-semibold rounded-full hover:bg-gray-100 transition">
                    Hubungi Kami
                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
                </a>
                <a href="{{ url('/ppdb')}}" class="inline-flex items-center justify-center px-8 py-4 bg-[#287f3b] text-white font-semibold rounded-full hover:bg-[#1f6a31] transition">
                    Daftar Sekarang
                </a>
            </div>
        </div>
