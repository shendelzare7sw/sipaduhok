            ...
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-body">
                            ...
                            <div class="mb-3 mt-2">
                                @if($user->foto_profil)
                                    <img src="{{ asset('storage/' . $user->foto_profil) }}"
                                         ...
                                         height="120" width="120" style="object-fit: cover; border: 3px solid #696cff;">
                                @else
                    ...
                    <div class="d-flex justify-content-center flex-wrap gap-2 mt-2">
                        <form action="{{ route('profile.upload-foto') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                            @csrf
                            <input type="file" name="foto_profil" id="foto_profil" class="d-none" accept="image/*" onchange="document.getElementById('uploadForm').submit()">
                        ...
                        @if($user->foto_profil)
                            <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteFotoModal">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <span>Status</span>
                            <span class="badge {{ $profileData->status === 'aktif' ? 'bg-label-success' : 'bg-label-secondary' }}">
                        ...
                        <form action="{{ route('profile.update') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control bg-light" value="{{ $profileData->nama_lengkap ?? $user->name }}" readonly disabled>
                                </div>

                                @if(isset($profileData->nip) || isset($profileData->nis))
                                <div class="col-md-6 mb-3">
                                    <label class="form-label text-uppercase">{{ $roleName === 'siswa' ? 'NIS' : 'NIP' }}</label>
                                    <input type="text" class="form-control bg-light" value="{{ $profileData->nip ?? $profileData->nis ?? '-' }}" readonly disabled>
                                </div>
                                @endif
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="no_telepon" id="no_telepon" class="form-control @error('no_telepon') is-invalid @enderror"
                                               value="{{ old('no_telepon', $profileData->no_telepon ?? '') }}" placeholder="08xxxxxxxxxx">
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control bg-light" value="{{ ($profileData->jenis_kelamin ?? '') == 'L' ? 'Laki-laki' : 'Perempuan' }}" readonly disabled>
                                </div>

                                <div class="col-12 mb-3">
                                    <label for="alamat" class="form-label">Alamat Lengkap</label>
                                    <textarea name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3">{{ old('alamat', $profileData->alamat ?? '') }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="badge bg-label-info">{{ $user->roleRelation ? $user->roleRelation->display_name : 'User' }}</span>
                            </div>
                            <div class="col-md-6">
