        ...
        <div class="login-container">
            ...
            <div class="glass-effect w-full max-w-5xl mx-auto rounded-3xl shadow-2xl overflow-hidden slide-in">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    ...
                    <div class="p-6 sm:p-8 md:p-10 lg:px-14 bg-white min-h-[600px] flex flex-col justify-center">

                        <!-- Back to Home Link -->
                        <a href="/" class="inline-flex items-center gap-2 text-[#165fac] font-semibold mb-5 sm:mb-8 hover:text-[#287f3b] transition text-sm">
                        ...
                        <div class="lg:hidden flex items-center gap-3 mb-5">
                            <div class="mobile-logo-container w-12 h-12 shrink-0 bg-gradient-to-br from-[#165fac] to-[#287f3b] rounded-xl shadow-lg flex items-center justify-center transform hover:rotate-12 transition-transform duration-300">
