...
@section('title', 'Jadwalkan Meeting')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="mb-0 fw-bold">Jadwalkan Meeting Baru</h5>
                    </div>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('guru.lms.meeting.store', [$kelas->id, $mapel->id]) }}" method="POST">
                        @csrf

                        <div class="mb-3">
                            <label class="form-label">Judul Pertemuan <span class="text-danger">*</span></label>
                            <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror"
                                value="{{ old('judul') }}" placeholder="Contoh: Pembahasan Bab 3 - Trigonometri" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="platform" class="form-select @error('platform') is-invalid @enderror"
                                    ...
                                    <option value="lainnya" {{ old('platform') == 'lainnya' ? 'selected' : '' }}>Lainnya
                                    </option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="url" name="link_meeting"
                                    ...
                                    value="{{ old('link_meeting') }}" placeholder="https://meet.google.com/..." required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                                rows="4" placeholder="Instruksi untuk siswa...">{{ old('deskripsi') }}</textarea>
