...
<style>
    ...
    .preview-banner-text { display: flex; align-items: center; gap: 14px; flex: 1; min-width: 240px; }
    .preview-banner-icon { font-size: 1.4rem; opacity: 0.95; flex-shrink: 0; }
    .preview-banner-title { font-size: 0.95rem; font-weight: 700; margin-bottom: 2px; }
    .preview-banner-subtitle { font-size: 0.75rem; opacity: 0.92; line-height: 1.4; }
    .btn-banner-salin {
        background: white;
        color: #4361ee;
        border: none;
    ...
    .btn-banner-salin:hover { background: #f8fafc; transform: translateY(-2px); color: #3651d4; }
    ...
    .preview-section-title { font-size: 1.2rem; font-weight: 700; color: #1e293b; margin: 0 0 8px 0; }
    .preview-meta-row {
    ...
    .preview-meta-row i { color: #4361ee; margin-right: 4px; }
    ...
    .preview-section-body { color: #1e293b; line-height: 1.7; font-size: 0.9rem; }
    ...
    .preview-file-box i { font-size: 2.2rem; color: #4361ee; margin-bottom: 10px; display: block; }
    ...
    .setting-item i { color: #4361ee; }

    .soal-list { display: grid; gap: 14px; }
    .soal-card { background: #f8fafc; border: 1px solid #e5e7eb; border-radius: 10px; padding: 16px; }
    .soal-header {
        display: flex; justify-content: space-between; align-items: center;
        gap: 10px; margin-bottom: 12px; flex-wrap: wrap;
    }
    .soal-nomor { font-weight: 700; color: #1e293b; font-size: 0.88rem; }
    .soal-meta { display: flex; gap: 8px; align-items: center; flex-wrap: wrap; }
    .soal-badge {
    ...
    .soal-narasi {
        background: white; border-left: 3px solid #4361ee;
        padding: 10px 14px; border-radius: 6px;
        font-size: 0.82rem; color: #64748b; margin-bottom: 10px; font-style: italic;
    }
    ...
    .soal-kunci {
        ...
        color: #15803d;
        padding: 9px 13px; border-radius: 8px; font-size: 0.82rem;
    }
    .kunci-essay {
    ...
    @media (max-width: 768px) {
        ...
        .btn-banner-salin { width: 100%; padding: 11px; }
