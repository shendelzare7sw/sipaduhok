            ...
            <form action="{{ route('guru.lms.tugas.update', [$kelas->id, $mapel->id, $tugas->id]) }}" 
                ...
                <div class="mb-4">
                    ...
                    <div class="p-3 border rounded bg-light">
                        ...
                        <div id="batasPengulanganContainer" class="pl-10" data-repeat-container @if(!$bisaDiulang) hidden @endif>
                            <label for="batasPengulangan" class="form-label fw-semibold">Batas Edit (Kali)</label>
                            <input type="number" class="form-control max-w-[200px]" id="batasPengulangan" name="batas_pengulangan" min="0" placeholder="Kosongkan jika tak terbatas" value="{{ old('batas_pengulangan', $tugas->batas_pengulangan) }}" data-repeat-input>
