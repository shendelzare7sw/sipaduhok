...
function filterPrintKelas() {
    const cabangSelect = document.getElementById('printCabangId');
    const cabangId = cabangSelect ? cabangSelect.value : '';
    const kelasSelect = document.getElementById('printKelasId');
    if (!kelasSelect) return;
    const options = kelasSelect.querySelectorAll('option[data-cabang]');

    kelasSelect.value = "";
    kelasSelect.disabled = Boolean(cabangSelect) && cabangId === "";
