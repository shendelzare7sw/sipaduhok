...
window.showCostModal = function() {
    const costModal = document.getElementById('costModal');
    if (costModal) { costModal.classList.remove('hidden'); costModal.classList.add('flex'); }
};

window.closeCostModal = function() {
    const costModal = document.getElementById('costModal');
    if (costModal) { costModal.classList.add('hidden'); costModal.classList.remove('flex'); }
};

window.showCostModalPaketA = function() {
    const costModal = document.getElementById('costModalPaketA');
    if (costModal) { costModal.classList.remove('hidden'); costModal.classList.add('flex'); }
};

window.closeCostModalPaketA = function() {
    const costModal = document.getElementById('costModalPaketA');
    if (costModal) { costModal.classList.add('hidden'); costModal.classList.remove('flex'); }
};

window.showCostModalPaketB = function() {
    const costModal = document.getElementById('costModalPaketB');
    if (costModal) { costModal.classList.remove('hidden'); costModal.classList.add('flex'); }
};

window.closeCostModalPaketB = function() {
    const costModal = document.getElementById('costModalPaketB');
    if (costModal) { costModal.classList.add('hidden'); costModal.classList.remove('flex'); }
};

window.showCostModalPaketC = function() {
    const costModal = document.getElementById('costModalPaketC');
    if (costModal) { costModal.classList.remove('hidden'); costModal.classList.add('flex'); }
};

window.closeCostModalPaketC = function() {
    const costModal = document.getElementById('costModalPaketC');
    if (costModal) { costModal.classList.add('hidden'); costModal.classList.remove('flex'); }
};
